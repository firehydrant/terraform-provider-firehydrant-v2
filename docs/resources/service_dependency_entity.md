...
page_title: "firehydrant_service_dependency_entity Resource - terraform-provider-firehydrant"
subcategory: ""
description: |-
  ServiceDependencyEntity Resource
---

# firehydrant_service_dependency_entity (Resource)
...
```terraform
resource "firehydrant_service_dependency_entity" "my_servicedependencyentity" {
