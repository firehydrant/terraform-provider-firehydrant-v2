...
<a id="nestedatt--connected_service--owner--ms_teams_channel--incident--impacts--condition"></a>
...
- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--connected_service--owner--ms_teams_channel--incident--ticket--assignees))
- `created_at` (String)
...
<a id="nestedatt--connected_service--teams--ms_teams_channel--incident--conference_bridges"></a>
...
<a id="nestedatt--connected_service--teams--ms_teams_channel--incident--impacts--condition"></a>
...
- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--connected_service--teams--ms_teams_channel--incident--ticket--assignees))
- `created_at` (String)
...
- `priority` (Attributes) Ticketing_PriorityEntity model (see [below for nested schema](#nestedatt--connected_service--teams--ms_teams_channel--incident--ticket--priority))
- `state` (String) must be one of ["open", "in_progress", "cancelled", "done"]
- `summary` (String)
- `tag_list` (List of String)
- `task_id` (String) ID of task that this ticket is related to
...
<a id="nestedatt--connected_service--teams--ms_teams_channel--incident--ticket--assignees"></a>
### Nested Schema for `connected_service.teams.ms_teams_channel.incident.ticket.assignees`
...
<a id="nestedatt--connected_service--teams--ms_teams_channel--incident--ticket--created_by"></a>
### Nested Schema for `connected_service.teams.ms_teams_channel.incident.ticket.created_by`
...
<a id="nestedatt--connected_service--teams--ms_teams_channel--incident--ticket--link"></a>
### Nested Schema for `connected_service.teams.ms_teams_channel.incident.ticket.link`
...
<a id="nestedatt--connected_service--teams--ms_teams_channel--incident--ticket--priority"></a>
### Nested Schema for `connected_service.teams.ms_teams_channel.incident.ticket.priority`
...
- `channel_url` (String)
- `id` (String)
- `incident` (Attributes) IncidentEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident))
- `ms_team_id` (String)
- `status` (String)
- `team_name` (String)

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident`
...
- `channel_reference` (String)
- `channel_status` (String) inoperative: 0, operational: 1, archived: 2
- `conference_bridges` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--conference_bridges))
- `context_object` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--context_object))
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--conversations))
- `created_at` (String) The time the incident was opened
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--created_by))
- `current_milestone` (String) The type/slug of the current milestone. Will be one of the currently configured milestones for the given incident.
- `custom_fields` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--custom_fields))
- `customer_impact_summary` (String)
- `customers_impacted` (Number)
- `description` (String)
- `discarded_at` (String) The time the incident was archived
- `environments` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--environments))
- `field_requirements` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--field_requirements))
- `functionalities` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--functionalities))
- `id` (String) UUID of the Incident
- `impacts` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts))
- `incident_channels` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_channels))
- `incident_tickets` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets))
- `incident_url` (String)
- `labels` (Map of String) A key/value of labels
- `last_note` (Attributes) Event_NoteEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note))
- `last_update` (String)
- `lifecycle_measurements` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_measurements))
- `lifecycle_phases` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_phases))
- `milestones` (Attributes List) DEPRECATED: Please use lifecycle phases instead (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--milestones))
- `monetary_impact` (Number)
- `monetary_impact_cents` (Number)
- `name` (String) Name of the incident
- `number` (Number) Incident number
- `organization` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--organization))
- `organization_id` (String)
- `priority` (String)
- `private_id` (String)
- `private_status_page_url` (String)
- `report_id` (String)
- `role_assignments` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--role_assignments))
- `services` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--services))
- `severity` (String)
- `severity_color` (String)
- `severity_condition` (String)
- `severity_condition_object` (Attributes) SeverityMatrix_ConditionEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--severity_condition_object))
- `severity_impact` (String)
- `severity_impact_object` (Attributes) SeverityMatrix_ImpactEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--severity_impact_object))
- `started_at` (String) The time the incident started
- `status_pages` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--status_pages))
- `summary` (String)
- `tag_list` (List of String)
- `team_assignments` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--team_assignments))
- `ticket` (Attributes) Ticketing_TicketEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket))

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--conference_bridges"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.conference_bridges`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--context_object"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.context_object`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--conversations"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--conversations--channel"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.conversations.channel`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--created_by"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.created_by`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--custom_fields"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.custom_fields`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--environments"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.environments`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--field_requirements"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.field_requirements`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--functionalities"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.functionalities`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.impacts`

Read-Only:

- `condition` (Attributes) SeverityMatrix_ConditionEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--condition))
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--conversations))
- `id` (String)
- `impact` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--impact))
- `type` (String) must be one of ["environment", "functionality", "service"]

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--condition"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.impacts.condition`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--conversations"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.impacts.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--conversations--channel"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.impacts.conversations.channel`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--impacts--impact"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.impacts.impact`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_channels"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.incident_channels`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.incident_tickets`

Read-Only:

- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--assignees))
- `created_at` (String)
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--created_by))
- `description` (String)
- `due_at` (String)
- `id` (String)
- `incident_current_milestone` (String) Milestone of incident that this ticket is related to
- `incident_id` (String) ID of incident that this ticket is related to
- `incident_name` (String) Name of incident that this ticket is related to
- `link` (Attributes) Attachments_LinkEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--link))
- `priority` (Attributes) Ticketing_PriorityEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--priority))
- `state` (String) must be one of ["open", "in_progress", "cancelled", "done"]
- `summary` (String)
- `tag_list` (List of String)
- `task_id` (String) ID of task that this ticket is related to
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--assignees"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.incident_tickets.assignees`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--created_by"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.incident_tickets.created_by`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--link"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.incident_tickets.link`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--incident_tickets--priority"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.incident_tickets.priority`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.last_note`

Read-Only:

- `body` (String)
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--conversations))
- `created_at` (String)
- `id` (String)
- `status_pages` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--status_pages))

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--conversations"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.last_note.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--conversations--channel"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.last_note.conversations.channel`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--status_pages"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.last_note.status_pages`
...
- `external_id` (String)
- `id` (String)
- `integration` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--status_pages--integration))
- `name` (String)
- `url` (String)

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--last_note--status_pages--integration"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.last_note.status_pages.integration`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_measurements"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.lifecycle_measurements`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_phases"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.lifecycle_phases`

Read-Only:

- `description` (String)
- `id` (String)
- `milestones` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_phases--milestones))
- `name` (String)
- `position` (Number)
- `type` (String)

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_phases--milestones"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.lifecycle_phases.milestones`
...
- `slug` (String)
- `updated_at` (String)
- `updated_by` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_phases--milestones--updated_by))

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--lifecycle_phases--milestones--updated_by"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.lifecycle_phases.milestones.updated_by`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--milestones"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.milestones`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--organization"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.organization`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--role_assignments"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.role_assignments`

Read-Only:

- `created_at` (String)
- `id` (String)
- `incident_role` (Attributes) IncidentRoleEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--role_assignments--incident_role))
- `status` (String) must be one of ["active", "inactive"]
- `updated_at` (String)
- `user` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--role_assignments--user))

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--role_assignments--incident_role"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.role_assignments.incident_role`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--role_assignments--user"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.role_assignments.user`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--services"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.services`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--severity_condition_object"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.severity_condition_object`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--severity_impact_object"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.severity_impact_object`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--status_pages"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.status_pages`
...
- `external_id` (String)
- `id` (String)
- `integration` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--status_pages--integration))
- `name` (String)
- `url` (String)

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--status_pages--integration"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.status_pages.integration`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--team_assignments"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.team_assignments`
...
- `id` (String)
- `status` (String)
- `team` (Attributes) TeamEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--team_assignments--team))
- `updated_at` (String)

<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--team_assignments--team"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.team_assignments.team`



<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.ticket`

Read-Only:

- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--assignees))
- `created_at` (String)
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--created_by))
- `description` (String)
- `due_at` (String)
- `id` (String)
- `incident_current_milestone` (String) Milestone of incident that this ticket is related to
- `incident_id` (String) ID of incident that this ticket is related to
- `incident_name` (String) Name of incident that this ticket is related to
- `link` (Attributes) Attachments_LinkEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--link))
- `priority` (Attributes) Ticketing_PriorityEntity model (see [below for nested schema](#nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--priority))
- `state` (String) must be one of ["open", "in_progress", "cancelled", "done"]
- `summary` (String)
- `tag_list` (List of String)
- `task_id` (String) ID of task that this ticket is related to
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--assignees"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.ticket.assignees`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--created_by"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.ticket.created_by`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--link"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.ticket.link`
...
<a id="nestedatt--service--checklists--owner--ms_teams_channel--incident--ticket--priority"></a>
### Nested Schema for `service.checklists.owner.ms_teams_channel.incident.ticket.priority`
...
- `channel_url` (String)
- `id` (String)
- `incident` (Attributes) IncidentEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident))
- `ms_team_id` (String)
- `status` (String)
- `team_name` (String)

<a id="nestedatt--service--owner--ms_teams_channel--incident"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident`
...
- `channel_reference` (String)
- `channel_status` (String) inoperative: 0, operational: 1, archived: 2
- `conference_bridges` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--conference_bridges))
- `context_object` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--context_object))
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--conversations))
- `created_at` (String) The time the incident was opened
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--created_by))
- `current_milestone` (String) The type/slug of the current milestone. Will be one of the currently configured milestones for the given incident.
- `custom_fields` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--custom_fields))
- `customer_impact_summary` (String)
- `customers_impacted` (Number)
- `description` (String)
- `discarded_at` (String) The time the incident was archived
- `environments` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--environments))
- `field_requirements` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--field_requirements))
- `functionalities` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--functionalities))
- `id` (String) UUID of the Incident
- `impacts` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--impacts))
- `incident_channels` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--incident_channels))
- `incident_tickets` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--incident_tickets))
- `incident_url` (String)
- `labels` (Map of String) A key/value of labels
- `last_note` (Attributes) Event_NoteEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--last_note))
- `last_update` (String)
- `lifecycle_measurements` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--lifecycle_measurements))
- `lifecycle_phases` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--lifecycle_phases))
- `milestones` (Attributes List) DEPRECATED: Please use lifecycle phases instead (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--milestones))
- `monetary_impact` (Number)
- `monetary_impact_cents` (Number)
- `name` (String) Name of the incident
- `number` (Number) Incident number
- `organization` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--organization))
- `organization_id` (String)
- `priority` (String)
- `private_id` (String)
- `private_status_page_url` (String)
- `report_id` (String)
- `role_assignments` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--role_assignments))
- `services` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--services))
- `severity` (String)
- `severity_color` (String)
- `severity_condition` (String)
- `severity_condition_object` (Attributes) SeverityMatrix_ConditionEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--severity_condition_object))
- `severity_impact` (String)
- `severity_impact_object` (Attributes) SeverityMatrix_ImpactEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--severity_impact_object))
- `started_at` (String) The time the incident started
- `status_pages` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--status_pages))
- `summary` (String)
- `tag_list` (List of String)
- `team_assignments` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--team_assignments))
- `ticket` (Attributes) Ticketing_TicketEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--ticket))

<a id="nestedatt--service--owner--ms_teams_channel--incident--conference_bridges"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.conference_bridges`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--context_object"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.context_object`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--conversations"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--conversations--channel"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.conversations.channel`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--created_by"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.created_by`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--custom_fields"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.custom_fields`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--environments"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.environments`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--field_requirements"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.field_requirements`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--functionalities"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.functionalities`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--impacts"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.impacts`

Read-Only:

- `condition` (Attributes) SeverityMatrix_ConditionEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--impacts--condition))
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--impacts--conversations))
- `id` (String)
- `impact` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--impacts--impact))
- `type` (String) must be one of ["environment", "functionality", "service"]

<a id="nestedatt--service--owner--ms_teams_channel--incident--impacts--condition"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.impacts.condition`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--impacts--conversations"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.impacts.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--impacts--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--impacts--conversations--channel"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.impacts.conversations.channel`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--impacts--impact"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.impacts.impact`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--incident_channels"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.incident_channels`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--incident_tickets"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.incident_tickets`

Read-Only:

- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--assignees))
- `created_at` (String)
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--created_by))
- `description` (String)
- `due_at` (String)
- `id` (String)
- `incident_current_milestone` (String) Milestone of incident that this ticket is related to
- `incident_id` (String) ID of incident that this ticket is related to
- `incident_name` (String) Name of incident that this ticket is related to
- `link` (Attributes) Attachments_LinkEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--link))
- `priority` (Attributes) Ticketing_PriorityEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--priority))
- `state` (String) must be one of ["open", "in_progress", "cancelled", "done"]
- `summary` (String)
- `tag_list` (List of String)
- `task_id` (String) ID of task that this ticket is related to
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--assignees"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.incident_tickets.assignees`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--created_by"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.incident_tickets.created_by`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--link"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.incident_tickets.link`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--incident_tickets--priority"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.incident_tickets.priority`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--last_note"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.last_note`

Read-Only:

- `body` (String)
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--last_note--conversations))
- `created_at` (String)
- `id` (String)
- `status_pages` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--last_note--status_pages))

<a id="nestedatt--service--owner--ms_teams_channel--incident--last_note--conversations"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.last_note.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--last_note--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--last_note--conversations--channel"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.last_note.conversations.channel`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--last_note--status_pages"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.last_note.status_pages`
...
- `external_id` (String)
- `id` (String)
- `integration` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--last_note--status_pages--integration))
- `name` (String)
- `url` (String)

<a id="nestedatt--service--owner--ms_teams_channel--incident--last_note--status_pages--integration"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.last_note.status_pages.integration`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--lifecycle_measurements"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.lifecycle_measurements`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--lifecycle_phases"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.lifecycle_phases`

Read-Only:

- `description` (String)
- `id` (String)
- `milestones` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--lifecycle_phases--milestones))
- `name` (String)
- `position` (Number)
- `type` (String)

<a id="nestedatt--service--owner--ms_teams_channel--incident--lifecycle_phases--milestones"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.lifecycle_phases.milestones`
...
- `slug` (String)
- `updated_at` (String)
- `updated_by` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--lifecycle_phases--milestones--updated_by))

<a id="nestedatt--service--owner--ms_teams_channel--incident--lifecycle_phases--milestones--updated_by"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.lifecycle_phases.milestones.updated_by`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--milestones"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.milestones`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--organization"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.organization`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--role_assignments"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.role_assignments`

Read-Only:

- `created_at` (String)
- `id` (String)
- `incident_role` (Attributes) IncidentRoleEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--role_assignments--incident_role))
- `status` (String) must be one of ["active", "inactive"]
- `updated_at` (String)
- `user` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--role_assignments--user))

<a id="nestedatt--service--owner--ms_teams_channel--incident--role_assignments--incident_role"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.role_assignments.incident_role`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--role_assignments--user"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.role_assignments.user`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--services"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.services`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--severity_condition_object"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.severity_condition_object`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--severity_impact_object"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.severity_impact_object`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--status_pages"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.status_pages`
...
- `external_id` (String)
- `id` (String)
- `integration` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--status_pages--integration))
- `name` (String)
- `url` (String)

<a id="nestedatt--service--owner--ms_teams_channel--incident--status_pages--integration"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.status_pages.integration`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--team_assignments"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.team_assignments`
...
- `id` (String)
- `status` (String)
- `team` (Attributes) TeamEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--team_assignments--team))
- `updated_at` (String)

<a id="nestedatt--service--owner--ms_teams_channel--incident--team_assignments--team"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.team_assignments.team`



<a id="nestedatt--service--owner--ms_teams_channel--incident--ticket"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.ticket`

Read-Only:

- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--ticket--assignees))
- `created_at` (String)
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--ticket--created_by))
- `description` (String)
- `due_at` (String)
- `id` (String)
- `incident_current_milestone` (String) Milestone of incident that this ticket is related to
- `incident_id` (String) ID of incident that this ticket is related to
- `incident_name` (String) Name of incident that this ticket is related to
- `link` (Attributes) Attachments_LinkEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--ticket--link))
- `priority` (Attributes) Ticketing_PriorityEntity model (see [below for nested schema](#nestedatt--service--owner--ms_teams_channel--incident--ticket--priority))
- `state` (String) must be one of ["open", "in_progress", "cancelled", "done"]
- `summary` (String)
- `tag_list` (List of String)
- `task_id` (String) ID of task that this ticket is related to
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--ticket--assignees"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.ticket.assignees`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--ticket--created_by"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.ticket.created_by`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--ticket--link"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.ticket.link`
...
<a id="nestedatt--service--owner--ms_teams_channel--incident--ticket--priority"></a>
### Nested Schema for `service.owner.ms_teams_channel.incident.ticket.priority`
...
- `channel_url` (String)
- `id` (String)
- `incident` (Attributes) IncidentEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident))
- `ms_team_id` (String)
- `status` (String)
- `team_name` (String)

<a id="nestedatt--service--teams--ms_teams_channel--incident"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident`
...
- `channel_reference` (String)
- `channel_status` (String) inoperative: 0, operational: 1, archived: 2
- `conference_bridges` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--conference_bridges))
- `context_object` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--context_object))
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--conversations))
- `created_at` (String) The time the incident was opened
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--created_by))
- `current_milestone` (String) The type/slug of the current milestone. Will be one of the currently configured milestones for the given incident.
- `custom_fields` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--custom_fields))
- `customer_impact_summary` (String)
- `customers_impacted` (Number)
- `description` (String)
- `discarded_at` (String) The time the incident was archived
- `environments` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--environments))
- `field_requirements` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--field_requirements))
- `functionalities` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--functionalities))
- `id` (String) UUID of the Incident
- `impacts` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--impacts))
- `incident_channels` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--incident_channels))
- `incident_tickets` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--incident_tickets))
- `incident_url` (String)
- `labels` (Map of String) A key/value of labels
- `last_note` (Attributes) Event_NoteEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--last_note))
- `last_update` (String)
- `lifecycle_measurements` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--lifecycle_measurements))
- `lifecycle_phases` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--lifecycle_phases))
- `milestones` (Attributes List) DEPRECATED: Please use lifecycle phases instead (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--milestones))
- `monetary_impact` (Number)
- `monetary_impact_cents` (Number)
- `name` (String) Name of the incident
- `number` (Number) Incident number
- `organization` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--organization))
- `organization_id` (String)
- `priority` (String)
- `private_id` (String)
- `private_status_page_url` (String)
- `report_id` (String)
- `role_assignments` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--role_assignments))
- `services` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--services))
- `severity` (String)
- `severity_color` (String)
- `severity_condition` (String)
- `severity_condition_object` (Attributes) SeverityMatrix_ConditionEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--severity_condition_object))
- `severity_impact` (String)
- `severity_impact_object` (Attributes) SeverityMatrix_ImpactEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--severity_impact_object))
- `started_at` (String) The time the incident started
- `status_pages` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--status_pages))
- `summary` (String)
- `tag_list` (List of String)
- `team_assignments` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--team_assignments))
- `ticket` (Attributes) Ticketing_TicketEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--ticket))

<a id="nestedatt--service--teams--ms_teams_channel--incident--conference_bridges"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.conference_bridges`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--context_object"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.context_object`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--conversations"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--conversations--channel"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.conversations.channel`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--created_by"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.created_by`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--custom_fields"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.custom_fields`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--environments"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.environments`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--field_requirements"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.field_requirements`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--functionalities"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.functionalities`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--impacts"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.impacts`

Read-Only:

- `condition` (Attributes) SeverityMatrix_ConditionEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--impacts--condition))
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--impacts--conversations))
- `id` (String)
- `impact` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--impacts--impact))
- `type` (String) must be one of ["environment", "functionality", "service"]

<a id="nestedatt--service--teams--ms_teams_channel--incident--impacts--condition"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.impacts.condition`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--impacts--conversations"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.impacts.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--impacts--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--impacts--conversations--channel"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.impacts.conversations.channel`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--impacts--impact"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.impacts.impact`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--incident_channels"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.incident_channels`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--incident_tickets"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.incident_tickets`

Read-Only:

- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--assignees))
- `created_at` (String)
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--created_by))
- `description` (String)
- `due_at` (String)
- `id` (String)
- `incident_current_milestone` (String) Milestone of incident that this ticket is related to
- `incident_id` (String) ID of incident that this ticket is related to
- `incident_name` (String) Name of incident that this ticket is related to
- `link` (Attributes) Attachments_LinkEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--link))
- `priority` (Attributes) Ticketing_PriorityEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--priority))
- `state` (String) must be one of ["open", "in_progress", "cancelled", "done"]
- `summary` (String)
- `tag_list` (List of String)
- `task_id` (String) ID of task that this ticket is related to
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--assignees"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.incident_tickets.assignees`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--created_by"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.incident_tickets.created_by`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--link"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.incident_tickets.link`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--incident_tickets--priority"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.incident_tickets.priority`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--last_note"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.last_note`

Read-Only:

- `body` (String)
- `conversations` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--last_note--conversations))
- `created_at` (String)
- `id` (String)
- `status_pages` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--last_note--status_pages))

<a id="nestedatt--service--teams--ms_teams_channel--incident--last_note--conversations"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.last_note.conversations`

Read-Only:

- `channel` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--last_note--conversations--channel))
- `comments_url` (String)
- `field` (String)
- `id` (String)
- `resource_class` (String)
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--last_note--conversations--channel"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.last_note.conversations.channel`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--last_note--status_pages"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.last_note.status_pages`
...
- `external_id` (String)
- `id` (String)
- `integration` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--last_note--status_pages--integration))
- `name` (String)
- `url` (String)

<a id="nestedatt--service--teams--ms_teams_channel--incident--last_note--status_pages--integration"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.last_note.status_pages.integration`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--lifecycle_measurements"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.lifecycle_measurements`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--lifecycle_phases"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.lifecycle_phases`

Read-Only:

- `description` (String)
- `id` (String)
- `milestones` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--lifecycle_phases--milestones))
- `name` (String)
- `position` (Number)
- `type` (String)

<a id="nestedatt--service--teams--ms_teams_channel--incident--lifecycle_phases--milestones"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.lifecycle_phases.milestones`
...
- `slug` (String)
- `updated_at` (String)
- `updated_by` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--lifecycle_phases--milestones--updated_by))

<a id="nestedatt--service--teams--ms_teams_channel--incident--lifecycle_phases--milestones--updated_by"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.lifecycle_phases.milestones.updated_by`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--milestones"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.milestones`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--organization"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.organization`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--role_assignments"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.role_assignments`

Read-Only:

- `created_at` (String)
- `id` (String)
- `incident_role` (Attributes) IncidentRoleEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--role_assignments--incident_role))
- `status` (String) must be one of ["active", "inactive"]
- `updated_at` (String)
- `user` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--role_assignments--user))

<a id="nestedatt--service--teams--ms_teams_channel--incident--role_assignments--incident_role"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.role_assignments.incident_role`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--role_assignments--user"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.role_assignments.user`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--services"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.services`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--severity_condition_object"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.severity_condition_object`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--severity_impact_object"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.severity_impact_object`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--status_pages"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.status_pages`
...
- `external_id` (String)
- `id` (String)
- `integration` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--status_pages--integration))
- `name` (String)
- `url` (String)

<a id="nestedatt--service--teams--ms_teams_channel--incident--status_pages--integration"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.status_pages.integration`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--team_assignments"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.team_assignments`
...
- `id` (String)
- `status` (String)
- `team` (Attributes) TeamEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--team_assignments--team))
- `updated_at` (String)

<a id="nestedatt--service--teams--ms_teams_channel--incident--team_assignments--team"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.team_assignments.team`



<a id="nestedatt--service--teams--ms_teams_channel--incident--ticket"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.ticket`

Read-Only:

- `assignees` (Attributes List) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--ticket--assignees))
- `created_at` (String)
- `created_by` (Attributes) (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--ticket--created_by))
- `description` (String)
- `due_at` (String)
- `id` (String)
- `incident_current_milestone` (String) Milestone of incident that this ticket is related to
- `incident_id` (String) ID of incident that this ticket is related to
- `incident_name` (String) Name of incident that this ticket is related to
- `link` (Attributes) Attachments_LinkEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--ticket--link))
- `priority` (Attributes) Ticketing_PriorityEntity model (see [below for nested schema](#nestedatt--service--teams--ms_teams_channel--incident--ticket--priority))
- `state` (String) must be one of ["open", "in_progress", "cancelled", "done"]
- `summary` (String)
- `tag_list` (List of String)
- `task_id` (String) ID of task that this ticket is related to
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--ticket--assignees"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.ticket.assignees`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--ticket--created_by"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.ticket.created_by`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--ticket--link"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.ticket.link`
...
<a id="nestedatt--service--teams--ms_teams_channel--incident--ticket--priority"></a>
### Nested Schema for `service.teams.ms_teams_channel.incident.ticket.priority`
