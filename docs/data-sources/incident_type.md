...
page_title: "firehydrant-terraform-sdk_incident_type Data Source - terraform-provider-firehydrant-terraform-sdk"
subcategory: ""
description: |-
  IncidentType DataSource
---

# firehydrant-terraform-sdk_incident_type (Data Source)
...
```terraform
data "firehydrant-terraform-sdk_incident_type" "my_incidenttype" {
  id = "...my_id..."
}
```
