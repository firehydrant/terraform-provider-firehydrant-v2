...
page_title: "firehydrant_scheduled_maintenance Data Source - terraform-provider-firehydrant"
subcategory: ""
description: |-
  ScheduledMaintenance DataSource
---

# firehydrant_scheduled_maintenance (Data Source)
...
```terraform
data "firehydrant_scheduled_maintenance" "my_scheduledmaintenance" {
}
```
