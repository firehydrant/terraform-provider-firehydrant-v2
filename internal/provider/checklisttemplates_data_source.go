...
var _ datasource.DataSource = &ChecklistTemplatesDataSource{}
var _ datasource.DataSourceWithConfigure = &ChecklistTemplatesDataSource{}

func NewChecklistTemplatesDataSource() datasource.DataSource {
	return &ChecklistTemplatesDataSource{}
}

// ChecklistTemplatesDataSource is the data source implementation.
type ChecklistTemplatesDataSource struct {
	client *sdk.Firehydrant
}

// ChecklistTemplatesDataSourceModel describes the data model.
type ChecklistTemplatesDataSourceModel struct {
	Data       []tfTypes.Checklists      `tfsdk:"data"`
...
func (r *ChecklistTemplatesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_checklist_templates"
}

// Schema defines the schema for the data source.
func (r *ChecklistTemplatesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ChecklistTemplates DataSource",
...
func (r *ChecklistTemplatesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ChecklistTemplatesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ChecklistTemplatesDataSourceModel
	...
	res, err := r.client.ChecklistTemplates.List(ctx, request)
	if err != nil {
	...
	data.RefreshFromSharedChecklistTemplateEntityPaginated(res.ChecklistTemplateEntityPaginated)
