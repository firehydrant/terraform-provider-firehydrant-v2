...
func (r *ChecklistTemplateEntityDataSourceModel) ToOperationsGetChecklistTemplateRequest(ctx context.Context) (*operations.GetChecklistTemplateRequest, diag.Diagnostics) {
...
func (r *ChecklistTemplateEntityDataSourceModel) RefreshFromSharedChecklistTemplateEntity(ctx context.Context, resp *shared.ChecklistTemplateEntity) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		if resp.Checks != nil {
			r.Checks = []tfTypes.ChecklistCheckEntity1{}
