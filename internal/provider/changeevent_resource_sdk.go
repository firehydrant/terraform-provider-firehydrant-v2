...
func (r *ChangeEventResourceModel) RefreshFromSharedChangeEvent(ctx context.Context, resp *shared.ChangeEvent) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Environments != nil {
			r.Environments = []tfTypes.EnvironmentEntry{}
			...
			for environmentsCount, environmentsItem := range resp.Environments {
				var environments tfTypes.EnvironmentEntry
				...
				if environmentsItem.ExternalResources != nil {
					environments.ExternalResources = []tfTypes.ExternalResource{}
		...
		if resp.Identities != nil {
			r.Identities = []tfTypes.ChangeIdentity{}
			...
			for identitiesCount, identitiesItem := range resp.Identities {
				var identities tfTypes.ChangeIdentity
		...
		if resp.RelatedChanges != nil {
			r.RelatedChanges = []tfTypes.Change{}
			...
			for relatedChangesCount, relatedChangesItem := range resp.RelatedChanges {
				var relatedChanges tfTypes.Change
...
func (r *ChangeEventResourceModel) ToOperationsGetChangeEventRequest(ctx context.Context) (*operations.GetChangeEventRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ChangeEventResourceModel) ToOperationsUpdateChangeEventRequest(ctx context.Context) (*operations.UpdateChangeEventRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ChangeEventResourceModel) ToSharedCreateChangeEvent(ctx context.Context) (*shared.CreateChangeEvent, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	var changeIdentities []shared.CreateChangeEventChangeIdentity
	if r.ChangeIdentities != nil {
		changeIdentities = make([]shared.CreateChangeEventChangeIdentity, 0, len(r.ChangeIdentities))
		for _, changeIdentitiesItem := range r.ChangeIdentities {
			...
			changeIdentities = append(changeIdentities, shared.CreateChangeEventChangeIdentity{
				Type:  type1,
				Value: value,
			})
		}
...
func (r *ChangeEventResourceModel) ToSharedUpdateChangeEvent(ctx context.Context) (*shared.UpdateChangeEvent, diag.Diagnostics) {
	var diags diag.Diagnostics
