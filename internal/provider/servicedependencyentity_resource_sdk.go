...
func (r *ServiceDependencyEntityResourceModel) ToSharedCreateServiceDependency(ctx context.Context) (*shared.CreateServiceDependency, diag.Diagnostics) {
	...
	out := shared.CreateServiceDependency{
...
func (r *ServiceDependencyEntityResourceModel) ToSharedUpdateServiceDependency(ctx context.Context) (*shared.UpdateServiceDependency, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := shared.UpdateServiceDependency{
		Notes: notes,
	}
...
func (r *ServiceDependencyEntityResourceModel) ToOperationsUpdateServiceDependencyRequest(ctx context.Context) (*operations.UpdateServiceDependencyRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var serviceDependencyID string
	serviceDependencyID = r.ID.ValueString()

	updateServiceDependency, updateServiceDependencyDiags := r.ToSharedUpdateServiceDependency(ctx)
	diags.Append(updateServiceDependencyDiags...)

	if diags.HasError() {
		return nil, diags
	}

	out := operations.UpdateServiceDependencyRequest{
...
func (r *ServiceDependencyEntityResourceModel) ToOperationsGetServiceDependencyRequest(ctx context.Context) (*operations.GetServiceDependencyRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ServiceDependencyEntityResourceModel) ToOperationsDeleteServiceDependencyRequest(ctx context.Context) (*operations.DeleteServiceDependencyRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var serviceDependencyID string
	serviceDependencyID = r.ID.ValueString()

	out := operations.DeleteServiceDependencyRequest{
		ServiceDependencyID: serviceDependencyID,
	}
...
func (r *ServiceDependencyEntityResourceModel) RefreshFromSharedServiceDependencyEntity(ctx context.Context, resp *shared.ServiceDependencyEntity) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		if resp.ConnectedService == nil {
			...
			r.ConnectedService = &tfTypes.NullableServiceEntity{}
			...
			if resp.ConnectedService.Checklists != nil {
				r.ConnectedService.Checklists = []tfTypes.ChecklistTemplateEntity{}
			...
			if resp.ConnectedService.LastImport == nil {
				...
				r.ConnectedService.LastImport = &tfTypes.NullableImportsImportableResourceEntity{}
			...
			if resp.ConnectedService.ManagedBySettings == nil {
				...
				r.ConnectedService.ManagedBySettings = &tfTypes.NullableServiceEntityManagedBySettings{}
			}
			...
			if resp.ConnectedService.Owner == nil {
				...
				r.ConnectedService.Owner = &tfTypes.NullableTeamEntityLite{}
				...
				if resp.ConnectedService.Owner.CreatedBy == nil {
					...
					r.ConnectedService.Owner.CreatedBy = &tfTypes.NullableAuthorEntity{}
			...
			if resp.ConnectedService.Teams != nil {
				r.ConnectedService.Teams = []tfTypes.TeamEntityLite{}
			...
			if resp.ConnectedService.UpdatedBy == nil {
				...
				r.ConnectedService.UpdatedBy = &tfTypes.NullableAuthorEntity{}
		...
		if resp.Service == nil {
			...
			r.Service = &tfTypes.NullableServiceEntity{}
			...
			if resp.Service.Checklists != nil {
				r.Service.Checklists = []tfTypes.ChecklistTemplateEntity{}
				...
				for checklistsCount1, checklistsItem1 := range resp.Service.Checklists {
					var checklists1 tfTypes.ChecklistTemplateEntity
					if checklistsItem1.Checks != nil {
						checklists1.Checks = []tfTypes.ChecklistCheckEntity1{}
						for checksCount1, checksItem1 := range checklistsItem1.Checks {
							var checks1 tfTypes.ChecklistCheckEntity1
					...
					if checklistsItem1.ConnectedServices != nil {
						checklists1.ConnectedServices = []tfTypes.ServiceEntityChecklist{}
						for connectedServicesCount1, connectedServicesItem1 := range checklistsItem1.ConnectedServices {
							var connectedServices1 tfTypes.ServiceEntityChecklist
							...
							if connectedServicesItem1.Labels == nil {
								...
								connectedServices1.Labels = &tfTypes.ServiceEntityChecklistLabels{}
							}
							...
							if connectedServicesItem1.Owner == nil {
								...
								connectedServices1.Owner = &tfTypes.NullableTeamEntityLite{}
								...
								if connectedServicesItem1.Owner.CreatedBy == nil {
									...
									connectedServices1.Owner.CreatedBy = &tfTypes.NullableAuthorEntity{}
					...
					if checklistsItem1.Owner == nil {
						...
						checklists1.Owner = &tfTypes.NullableTeamEntityLite{}
						...
						if checklistsItem1.Owner.CreatedBy == nil {
							...
							checklists1.Owner.CreatedBy = &tfTypes.NullableAuthorEntity{}
			...
			if resp.Service.ExternalResources != nil {
				...
				for externalResourcesCount2, externalResourcesItem2 := range resp.Service.ExternalResources {
					var externalResources2 tfTypes.ExternalResourceEntity
				...
				for functionalitiesCount1, functionalitiesItem1 := range resp.Service.Functionalities {
					...
					if functionalitiesItem1.Links != nil {
						...
						for linksCount2, linksItem2 := range functionalitiesItem1.Links {
							var links2 tfTypes.LinksEntity
					...
					if functionalitiesItem1.Services != nil {
						functionalities1.Services = []tfTypes.ServiceEntityLite{}
					...
					if functionalitiesItem1.Teams != nil {
						functionalities1.Teams = []tfTypes.TeamEntityLite{}
						for teamsCount2, teamsItem2 := range functionalitiesItem1.Teams {
							var teams2 tfTypes.TeamEntityLite
							...
							if teamsItem2.CreatedBy == nil {
								...
								teams2.CreatedBy = &tfTypes.NullableAuthorEntity{}
			...
			if resp.Service.LastImport == nil {
				...
				r.Service.LastImport = &tfTypes.NullableImportsImportableResourceEntity{}
				if resp.Service.LastImport.ImportErrors != nil {
					...
					for importErrorsCount1, importErrorsItem1 := range resp.Service.LastImport.ImportErrors {
						...
						if importErrorsItem1.Data == nil {
							...
							importErrors1.Data = &tfTypes.ImportsImportErrorEntityData{}
						}
						...
						if importErrorsItem1.Resource == nil {
							...
							importErrors1.Resource = &tfTypes.NullableImportsImportErrorEntityResourceEntity{}
			...
			if resp.Service.ManagedBySettings == nil {
				...
				r.Service.ManagedBySettings = &tfTypes.NullableServiceEntityManagedBySettings{}
			}
			r.Service.Name = types.StringPointerValue(resp.Service.Name)
			if resp.Service.Owner == nil {
				r.Service.Owner = nil
			} else {
				r.Service.Owner = &tfTypes.NullableTeamEntityLite{}
				...
				if resp.Service.Owner.CreatedBy == nil {
					...
					r.Service.Owner.CreatedBy = &tfTypes.NullableAuthorEntity{}
			...
			if resp.Service.Teams != nil {
				r.Service.Teams = []tfTypes.TeamEntityLite{}
				...
				for teamsCount3, teamsItem3 := range resp.Service.Teams {
					var teams3 tfTypes.TeamEntityLite
					...
					if teamsItem3.CreatedBy == nil {
						...
						teams3.CreatedBy = &tfTypes.NullableAuthorEntity{}
			...
			if resp.Service.UpdatedBy == nil {
				...
				r.Service.UpdatedBy = &tfTypes.NullableAuthorEntity{}
