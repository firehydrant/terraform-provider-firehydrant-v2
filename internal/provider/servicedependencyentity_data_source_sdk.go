...
func (r *ServiceDependencyEntityDataSourceModel) ToOperationsGetServiceDependencyRequest(ctx context.Context) (*operations.GetServiceDependencyRequest, diag.Diagnostics) {
...
func (r *ServiceDependencyEntityDataSourceModel) RefreshFromSharedServiceDependencyEntity(ctx context.Context, resp *shared.ServiceDependencyEntity) diag.Diagnostics {
	var diags diag.Diagnostics
