...
func (r *TicketingTicketEntityResourceModel) ToSharedCreateTicket(ctx context.Context) (*shared.CreateTicket, diag.Diagnostics) {
...
func (r *TicketingTicketEntityResourceModel) ToSharedUpdateTicket(ctx context.Context) (*shared.UpdateTicket, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TicketingTicketEntityResourceModel) ToOperationsUpdateTicketRequest(ctx context.Context) (*operations.UpdateTicketRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TicketingTicketEntityResourceModel) ToOperationsGetTicketRequest(ctx context.Context) (*operations.GetTicketRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
