...
type ChecklistTemplateResourceModel struct {
	Checks                 []tfTypes.ChecklistCheck                                `tfsdk:"checks"`
	ConnectedServices      []tfTypes.ServiceChecklist                              `tfsdk:"connected_services"`
...
func (r *ChecklistTemplateResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if !(res.ChecklistTemplate != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedChecklistTemplate(ctx, res.ChecklistTemplate)...)
	...
	if !(res1.ChecklistTemplate != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res1.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedChecklistTemplate(ctx, res1.ChecklistTemplate)...)
