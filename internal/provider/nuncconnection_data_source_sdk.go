...
func (r *NuncConnectionDataSourceModel) RefreshFromSharedNuncConnection(ctx context.Context, resp *shared.NuncConnection) diag.Diagnostics {
...
func (r *NuncConnectionDataSourceModel) ToOperationsGetNuncConnectionRequest(ctx context.Context) (*operations.GetNuncConnectionRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
