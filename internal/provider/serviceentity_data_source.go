...
var _ datasource.DataSource = &ServiceEntityDataSource{}
var _ datasource.DataSourceWithConfigure = &ServiceEntityDataSource{}

func NewServiceEntityDataSource() datasource.DataSource {
	return &ServiceEntityDataSource{}
}

// ServiceEntityDataSource is the data source implementation.
type ServiceEntityDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// ServiceEntityDataSourceModel describes the data model.
type ServiceEntityDataSourceModel struct {
...
func (r *ServiceEntityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_service_entity"
}

// Schema defines the schema for the data source.
func (r *ServiceEntityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ServiceEntity DataSource",
...
func (r *ServiceEntityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ServiceEntityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ServiceEntityDataSourceModel
