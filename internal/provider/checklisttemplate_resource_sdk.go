...
func (r *ChecklistTemplateResourceModel) RefreshFromSharedChecklistTemplate(ctx context.Context, resp *shared.ChecklistTemplate) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		r.Checks = []tfTypes.ChecklistCheck{}
		if len(r.Checks) > len(resp.Checks) {
			r.Checks = r.Checks[:len(resp.Checks)]
		}
		for checksCount, checksItem := range resp.Checks {
			var checks tfTypes.ChecklistCheck
		...
		if resp.ConnectedServices != nil {
			r.ConnectedServices = []tfTypes.ServiceChecklist{}
...
func (r *ChecklistTemplateResourceModel) ToOperationsDeleteChecklistTemplateRequest(ctx context.Context) (*operations.DeleteChecklistTemplateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ChecklistTemplateResourceModel) ToOperationsGetChecklistTemplateRequest(ctx context.Context) (*operations.GetChecklistTemplateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ChecklistTemplateResourceModel) ToOperationsUpdateChecklistTemplateRequest(ctx context.Context) (*operations.UpdateChecklistTemplateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ChecklistTemplateResourceModel) ToSharedCreateChecklistTemplate(ctx context.Context) (*shared.CreateChecklistTemplate, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ChecklistTemplateResourceModel) ToSharedUpdateChecklistTemplate(ctx context.Context) (*shared.UpdateChecklistTemplate, diag.Diagnostics) {
	var diags diag.Diagnostics
