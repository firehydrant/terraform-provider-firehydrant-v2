...
func (r *IntegrationsAwsConnectionDataSourceModel) RefreshFromSharedIntegrationsAwsConnection(ctx context.Context, resp *shared.IntegrationsAwsConnection) diag.Diagnostics {
...
func (r *IntegrationsAwsConnectionDataSourceModel) ToOperationsGetAwsConnectionRequest(ctx context.Context) (*operations.GetAwsConnectionRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
