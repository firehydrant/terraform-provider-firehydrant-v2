...
func (r *SeverityDataSourceModel) RefreshFromSharedSeverity(ctx context.Context, resp *shared.Severity) diag.Diagnostics {
...
func (r *SeverityDataSourceModel) ToOperationsGetSeverityRequest(ctx context.Context) (*operations.GetSeverityRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
