...
var _ datasource.DataSourceWithConfigure = &IncidentDataSource{}

func NewIncidentDataSource() datasource.DataSource {
	return &IncidentDataSource{}
}

// IncidentDataSource is the data source implementation.
type IncidentDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// IncidentDataSourceModel describes the data model.
type IncidentDataSourceModel struct {
	...
	Labels                  *tfTypes.IncidentLabels                  `tfsdk:"labels"`
...
func (r *IncidentDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_incident"
}

// Schema defines the schema for the data source.
func (r *IncidentDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Incident DataSource",
...
func (r *IncidentDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *IncidentDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
