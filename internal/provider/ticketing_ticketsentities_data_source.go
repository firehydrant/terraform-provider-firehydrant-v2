...
var _ datasource.DataSource = &TicketingTicketsEntitiesDataSource{}
var _ datasource.DataSourceWithConfigure = &TicketingTicketsEntitiesDataSource{}

func NewTicketingTicketsEntitiesDataSource() datasource.DataSource {
	return &TicketingTicketsEntitiesDataSource{}
}

// TicketingTicketsEntitiesDataSource is the data source implementation.
type TicketingTicketsEntitiesDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// TicketingTicketsEntitiesDataSourceModel describes the data model.
type TicketingTicketsEntitiesDataSourceModel struct {
...
func (r *TicketingTicketsEntitiesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ticketing_tickets_entities"
}

// Schema defines the schema for the data source.
func (r *TicketingTicketsEntitiesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "TicketingTicketsEntities DataSource",
...
func (r *TicketingTicketsEntitiesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *TicketingTicketsEntitiesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *TicketingTicketsEntitiesDataSourceModel
