...
func (r *IncidentsRetrospectiveFieldEntityDataSourceModel) ToOperationsGetIncidentRetrospectiveFieldRequest(ctx context.Context) (*operations.GetIncidentRetrospectiveFieldRequest, diag.Diagnostics) {
...
func (r *IncidentsRetrospectiveFieldEntityDataSourceModel) RefreshFromSharedIncidentsRetrospectiveFieldEntity(ctx context.Context, resp *shared.IncidentsRetrospectiveFieldEntity) diag.Diagnostics {
	var diags diag.Diagnostics
