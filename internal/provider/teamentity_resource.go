...
var _ resource.Resource = &TeamEntityResource{}
var _ resource.ResourceWithImportState = &TeamEntityResource{}

func NewTeamEntityResource() resource.Resource {
	return &TeamEntityResource{}
}

// TeamEntityResource defines the resource implementation.
type TeamEntityResource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// TeamEntityResourceModel describes the resource data model.
type TeamEntityResourceModel struct {
	CreatedAt                      types.String                                               `tfsdk:"created_at"`
	CreatedBy                      *tfTypes.NullableAuthorEntity                              `tfsdk:"created_by"`
	DefaultSignalsEscalationPolicy *tfTypes.NullableSuccinctEntity                            `tfsdk:"default_signals_escalation_policy"`
	Description                    types.String                                               `tfsdk:"description"`
	Functionalities                []tfTypes.FunctionalityEntityLite                          `tfsdk:"functionalities"`
	ID                             types.String                                               `tfsdk:"id"`
	InSupportHours                 types.Bool                                                 `tfsdk:"in_support_hours"`
	InviteEmails                   []types.String                                             `tfsdk:"invite_emails"`
	Memberships                    []tfTypes.MembershipEntity                                 `tfsdk:"memberships"`
	MembershipsInput               []tfTypes.CreateTeamMembershipsInput                       `tfsdk:"memberships_input"`
	MsTeamsChannel                 *tfTypes.NullableIntegrationsMicrosoftTeamsV2ChannelEntity `tfsdk:"ms_teams_channel"`
	MsTeamsChannelInput            *tfTypes.CreateTeamMsTeamsChannelInput                     `tfsdk:"ms_teams_channel_input"`
	Name                           types.String                                               `tfsdk:"name"`
	OwnedChecklistTemplates        []tfTypes.ChecklistTemplateEntity                          `tfsdk:"owned_checklist_templates"`
	OwnedFunctionalities           []tfTypes.FunctionalityEntityLite                          `tfsdk:"owned_functionalities"`
	OwnedRunbooks                  []tfTypes.SlimRunbookEntity                                `tfsdk:"owned_runbooks"`
	OwnedServices                  []tfTypes.ServiceEntityLite                                `tfsdk:"owned_services"`
	RespondingServices             []tfTypes.ServiceEntityLite                                `tfsdk:"responding_services"`
	Services                       []tfTypes.ServiceEntityLite                                `tfsdk:"services"`
	SignalsIcalURL                 types.String                                               `tfsdk:"signals_ical_url"`
	SlackChannel                   *tfTypes.NullableIntegrationsSlackSlackChannelEntity       `tfsdk:"slack_channel"`
	SlackChannelID                 types.String                                               `tfsdk:"slack_channel_id"`
	Slug                           types.String                                               `tfsdk:"slug"`
	UpdatedAt                      types.String                                               `tfsdk:"updated_at"`
}

func (r *TeamEntityResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_team_entity"
}

func (r *TeamEntityResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "TeamEntity Resource",
...
func (r *TeamEntityResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *TeamEntityResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *TeamEntityResourceModel
	...
	resp.Diagnostics.Append(data.RefreshFromSharedTeamEntity(ctx, res.TeamEntity)...)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedTeamEntity(ctx, res1.TeamEntity)...)
...
func (r *TeamEntityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *TeamEntityResourceModel
...
func (r *TeamEntityResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *TeamEntityResourceModel
	var plan types.Object
...
func (r *TeamEntityResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *TeamEntityResourceModel
	var item types.Object
...
func (r *TeamEntityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
