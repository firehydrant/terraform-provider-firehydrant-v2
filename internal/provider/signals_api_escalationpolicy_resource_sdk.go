...
func (r *SignalsAPIEscalationPolicyResourceModel) RefreshFromSharedSignalsAPIEscalationPolicy(ctx context.Context, resp *shared.SignalsAPIEscalationPolicy) diag.Diagnostics {
	...
	if resp != nil {
		...
		for stepsCount1, stepsItem1 := range resp.Steps {
			...
			steps1.Targets = []tfTypes.SignalsAPITarget1{}
			for targetsCount1, targetsItem1 := range stepsItem1.Targets {
				var targets1 tfTypes.SignalsAPITarget1
...
func (r *SignalsAPIEscalationPolicyResourceModel) ToOperationsCreateTeamEscalationPolicyRequest(ctx context.Context) (*operations.CreateTeamEscalationPolicyRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIEscalationPolicyResourceModel) ToOperationsGetTeamEscalationPolicyRequest(ctx context.Context) (*operations.GetTeamEscalationPolicyRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIEscalationPolicyResourceModel) ToOperationsUpdateTeamEscalationPolicyRequest(ctx context.Context) (*operations.UpdateTeamEscalationPolicyRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIEscalationPolicyResourceModel) ToSharedCreateTeamEscalationPolicy(ctx context.Context) (*shared.CreateTeamEscalationPolicy, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIEscalationPolicyResourceModel) ToSharedUpdateTeamEscalationPolicy(ctx context.Context) (*shared.UpdateTeamEscalationPolicy, diag.Diagnostics) {
	var diags diag.Diagnostics
