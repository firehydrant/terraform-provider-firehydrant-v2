...
func (r *NuncConnectionResourceModel) RefreshFromSharedNuncConnection(ctx context.Context, resp *shared.NuncConnection) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.ComponentGroups == nil {
			...
			r.ComponentGroups = &tfTypes.NullableNuncComponentGroup{}
		...
		if resp.Components == nil {
			...
			r.Components = &tfTypes.NullableNuncComponent{}
		...
		if resp.Conditions == nil {
			...
			r.Conditions = &tfTypes.NullableNuncCondition{}
		...
		if resp.Favicon == nil {
			...
			r.Favicon = &tfTypes.NullableMediaImage{}
...
func (r *NuncConnectionResourceModel) ToOperationsDeleteNuncImageRequest(ctx context.Context) (*operations.DeleteNuncImageRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	out := operations.DeleteNuncImageRequest{
...
func (r *NuncConnectionResourceModel) ToOperationsGetNuncConnectionRequest(ctx context.Context) (*operations.GetNuncConnectionRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *NuncConnectionResourceModel) ToOperationsUpdateNuncImageRequest(ctx context.Context) (*operations.UpdateNuncImageRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	updateNuncImageForm, updateNuncImageFormDiags := r.ToSharedUpdateNuncImageForm(ctx)
	diags.Append(updateNuncImageFormDiags...)

	if diags.HasError() {
		return nil, diags
	}

	out := operations.UpdateNuncImageRequest{
		NuncConnectionID:    nuncConnectionID,
		Type:                typeVar,
		UpdateNuncImageForm: updateNuncImageForm,
	}

	return &out, diags
}

func (r *NuncConnectionResourceModel) ToSharedCreateNuncConnection(ctx context.Context) (*shared.CreateNuncConnection, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *NuncConnectionResourceModel) ToSharedUpdateNuncImageForm(ctx context.Context) (*shared.UpdateNuncImageForm, diag.Diagnostics) {
	var diags diag.Diagnostics

	out := shared.UpdateNuncImageForm{}
