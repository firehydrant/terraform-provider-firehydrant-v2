...
var _ datasource.DataSource = &ScheduledMaintenanceEntityDataSource{}
var _ datasource.DataSourceWithConfigure = &ScheduledMaintenanceEntityDataSource{}

func NewScheduledMaintenanceEntityDataSource() datasource.DataSource {
	return &ScheduledMaintenanceEntityDataSource{}
}

// ScheduledMaintenanceEntityDataSource is the data source implementation.
type ScheduledMaintenanceEntityDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// ScheduledMaintenanceEntityDataSourceModel describes the data model.
type ScheduledMaintenanceEntityDataSourceModel struct {
	...
	Labels      *tfTypes.ScheduledMaintenanceEntityLabels       `tfsdk:"labels"`
...
func (r *ScheduledMaintenanceEntityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_scheduled_maintenance_entity"
}

// Schema defines the schema for the data source.
func (r *ScheduledMaintenanceEntityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ScheduledMaintenanceEntity DataSource",
...
func (r *ScheduledMaintenanceEntityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ScheduledMaintenanceEntityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ScheduledMaintenanceEntityDataSourceModel
