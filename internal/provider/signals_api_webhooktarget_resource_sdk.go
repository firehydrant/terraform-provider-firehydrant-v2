...
func (r *SignalsAPIWebhookTargetResourceModel) RefreshFromSharedSignalsAPIWebhookTarget(ctx context.Context, resp *shared.SignalsAPIWebhookTarget) diag.Diagnostics {
...
func (r *SignalsAPIWebhookTargetResourceModel) ToOperationsGetSignalsWebhookTargetRequest(ctx context.Context) (*operations.GetSignalsWebhookTargetRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIWebhookTargetResourceModel) ToOperationsUpdateSignalsWebhookTargetRequest(ctx context.Context) (*operations.UpdateSignalsWebhookTargetRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIWebhookTargetResourceModel) ToSharedCreateSignalsWebhookTarget(ctx context.Context) (*shared.CreateSignalsWebhookTarget, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIWebhookTargetResourceModel) ToSharedUpdateSignalsWebhookTarget(ctx context.Context) (*shared.UpdateSignalsWebhookTarget, diag.Diagnostics) {
	var diags diag.Diagnostics
