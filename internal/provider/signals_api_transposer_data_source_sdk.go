...
func (r *SignalsAPITransposerDataSourceModel) RefreshFromSharedSignalsAPITransposer(ctx context.Context, resp *shared.SignalsAPITransposer) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.ExamplePayload == nil {
			...
			r.ExamplePayload = &tfTypes.SignalsAPITransposerExamplePayload{}
		}
...
func (r *SignalsAPITransposerDataSourceModel) ToOperationsGetSignalsEventSourceRequest(ctx context.Context) (*operations.GetSignalsEventSourceRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
