...
var _ datasource.DataSource = &ServiceDependencyEntityDataSource{}
var _ datasource.DataSourceWithConfigure = &ServiceDependencyEntityDataSource{}

func NewServiceDependencyEntityDataSource() datasource.DataSource {
	return &ServiceDependencyEntityDataSource{}
}

// ServiceDependencyEntityDataSource is the data source implementation.
type ServiceDependencyEntityDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// ServiceDependencyEntityDataSourceModel describes the data model.
type ServiceDependencyEntityDataSourceModel struct {
...
func (r *ServiceDependencyEntityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_service_dependency_entity"
}

// Schema defines the schema for the data source.
func (r *ServiceDependencyEntityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ServiceDependencyEntity DataSource",
...
func (r *ServiceDependencyEntityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ServiceDependencyEntityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ServiceDependencyEntityDataSourceModel
