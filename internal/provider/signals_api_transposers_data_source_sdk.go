...
func (r *SignalsAPITransposersDataSourceModel) RefreshFromSharedSignalsAPITransposerList(ctx context.Context, resp *shared.SignalsAPITransposerList) diag.Diagnostics {
	...
	if resp != nil {
		if resp.Data == nil {
			...
			r.Data = &tfTypes.NullableSignalsAPITransposer{}
			if resp.Data.CreatedBy == nil {
				r.Data.CreatedBy = nil
			} else {
				r.Data.CreatedBy = &tfTypes.NullableAuthor{}
			...
			if resp.Data.ExamplePayload == nil {
				...
				r.Data.ExamplePayload = &tfTypes.NullableSignalsAPITransposerExamplePayload{}
			}
			...
			if resp.Data.UpdatedBy == nil {
				...
				r.Data.UpdatedBy = &tfTypes.NullableAuthor{}
...
func (r *SignalsAPITransposersDataSourceModel) ToOperationsListSignalsEventSourcesRequest(ctx context.Context) (*operations.ListSignalsEventSourcesRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
