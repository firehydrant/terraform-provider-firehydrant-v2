...
func (r *PostMortemsPostMortemReportEntityDataSourceModel) ToOperationsGetPostMortemReportRequest(ctx context.Context) (*operations.GetPostMortemReportRequest, diag.Diagnostics) {
...
func (r *PostMortemsPostMortemReportEntityDataSourceModel) RefreshFromSharedPostMortemsPostMortemReportEntity(ctx context.Context, resp *shared.PostMortemsPostMortemReportEntity) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		if resp.CalendarEvents == nil {
			...
			r.CalendarEvents = &tfTypes.NullableCalendarsEventEntity{}
		...
		if resp.Incident == nil {
			...
			r.Incident = &tfTypes.NullableIncidentEntity{}
			...
			if resp.Incident.ConferenceBridges != nil {
				r.Incident.ConferenceBridges = []tfTypes.IncidentsConferenceBridgeEntity{}
			...
			if resp.Incident.ContextObject == nil {
				...
				r.Incident.ContextObject = &tfTypes.NullableIncidentsContextObjectEntity{}
			...
			if resp.Incident.Conversations != nil {
				r.Incident.Conversations = []tfTypes.ConversationsAPIEntitiesReference{}
			...
			if resp.Incident.CreatedBy == nil {
				...
				r.Incident.CreatedBy = &tfTypes.NullableAuthorEntity{}
			...
			if resp.Incident.Environments != nil {
				r.Incident.Environments = []tfTypes.SuccinctEntity{}
			...
			if resp.Incident.FieldRequirements != nil {
				r.Incident.FieldRequirements = []tfTypes.IncidentEntityFieldRequirementEntity{}
			...
			if resp.Incident.Functionalities != nil {
				r.Incident.Functionalities = []tfTypes.SuccinctEntity{}
			...
			if resp.Incident.Impacts != nil {
				r.Incident.Impacts = []tfTypes.IncidentsImpactEntity{}
			...
			if resp.Incident.IncidentChannels != nil {
				r.Incident.IncidentChannels = []tfTypes.IncidentsChannelEntity{}
			...
			if resp.Incident.IncidentTickets != nil {
				r.Incident.IncidentTickets = []tfTypes.TicketingTicketEntity{}
			...
			if resp.Incident.IncidentType == nil {
				...
				r.Incident.IncidentType = &tfTypes.NullableSuccinctEntity{}
			...
			if resp.Incident.Labels == nil {
				...
				r.Incident.Labels = &tfTypes.NullableIncidentEntityLabels{}
			}
			if resp.Incident.LastNote == nil {
				r.Incident.LastNote = nil
			} else {
				r.Incident.LastNote = &tfTypes.NullableEventNoteEntity{}
				r.Incident.LastNote.Body = types.StringPointerValue(resp.Incident.LastNote.Body)
				if resp.Incident.LastNote.Conversations != nil {
					r.Incident.LastNote.Conversations = []tfTypes.ConversationsAPIEntitiesReference{}
				...
				if resp.Incident.LastNote.StatusPages != nil {
					r.Incident.LastNote.StatusPages = []tfTypes.IncidentsStatusPageEntity{}
			...
			if resp.Incident.LifecycleMeasurements != nil {
				r.Incident.LifecycleMeasurements = []tfTypes.IncidentsLifecycleMeasurementEntity{}
			...
			if resp.Incident.LifecyclePhases != nil {
				r.Incident.LifecyclePhases = []tfTypes.IncidentsLifecyclePhaseEntity{}
			...
			if resp.Incident.Milestones != nil {
				r.Incident.Milestones = []tfTypes.IncidentsMilestoneEntity{}
			...
			if resp.Incident.Organization == nil {
				...
				r.Incident.Organization = &tfTypes.NullableOrganizationEntity{}
			...
			if resp.Incident.RoleAssignments != nil {
				r.Incident.RoleAssignments = []tfTypes.IncidentsRoleAssignmentEntity{}
			...
			if resp.Incident.Services != nil {
				r.Incident.Services = []tfTypes.SuccinctEntity{}
			...
			if resp.Incident.SeverityConditionObject == nil {
				...
				r.Incident.SeverityConditionObject = &tfTypes.NullableSeverityMatrixConditionEntity{}
			...
			if resp.Incident.SeverityImpactObject == nil {
				...
				r.Incident.SeverityImpactObject = &tfTypes.NullableSeverityMatrixImpactEntity{}
			...
			if resp.Incident.StatusPages != nil {
				r.Incident.StatusPages = []tfTypes.IncidentsStatusPageEntity{}
			...
			if resp.Incident.TeamAssignments != nil {
				r.Incident.TeamAssignments = []tfTypes.IncidentsTeamAssignmentEntityLite{}
			...
			if resp.Incident.Ticket == nil {
				...
				r.Incident.Ticket = &tfTypes.NullableTicketingTicketEntity{}
				if resp.Incident.Ticket.Assignees != nil {
					r.Incident.Ticket.Assignees = []tfTypes.AuthorEntity{}
				...
				if resp.Incident.Ticket.CreatedBy == nil {
					...
					r.Incident.Ticket.CreatedBy = &tfTypes.NullableAuthorEntity{}
				...
				if resp.Incident.Ticket.Link == nil {
					...
					r.Incident.Ticket.Link = &tfTypes.NullableAttachmentsLinkEntity{}
				...
				if resp.Incident.Ticket.Priority == nil {
					...
					r.Incident.Ticket.Priority = &tfTypes.NullableTicketingPriorityEntity{}
		...
		if resp.Questions == nil {
			...
			r.Questions = &tfTypes.NullablePostMortemsQuestionEntity{}
			...
			if resp.Questions.Conversations != nil {
				r.Questions.Conversations = []tfTypes.ConversationsAPIEntitiesReference{}
				...
				for conversationsCount3, conversationsItem3 := range resp.Questions.Conversations {
					...
					if conversationsItem3.Channel == nil {
						...
						conversations3.Channel = &tfTypes.NullableConversationsAPIEntitiesChannel{}
