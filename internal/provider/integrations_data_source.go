...
var _ datasource.DataSourceWithConfigure = &IntegrationsDataSource{}
...
// IntegrationsDataSourceModel describes the data model.
type IntegrationsDataSourceModel struct {
	Connections   []tfTypes.IntegrationsConnection             `tfsdk:"connections"`
	...
	Logo          *tfTypes.NullableIntegrationsIntegrationLogo `tfsdk:"logo"`
...
func (r *IntegrationsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_integrations"
}

// Schema defines the schema for the data source.
func (r *IntegrationsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Integrations DataSource",
...
func (r *IntegrationsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *IntegrationsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedIntegrations(ctx, res.Integrations)...)
