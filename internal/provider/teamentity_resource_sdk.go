...
func (r *TeamEntityResourceModel) ToSharedCreateTeam(ctx context.Context) (*shared.CreateTeam, diag.Diagnostics) {
	...
	if r.InviteEmails != nil {
		inviteEmails = make([]string, 0, len(r.InviteEmails))
		for _, inviteEmailsItem := range r.InviteEmails {
			inviteEmails = append(inviteEmails, inviteEmailsItem.ValueString())
		}
	}
	var membershipsInput []shared.CreateTeamMembershipsInput
	if r.MembershipsInput != nil {
		membershipsInput = make([]shared.CreateTeamMembershipsInput, 0, len(r.MembershipsInput))
		for _, membershipsInputItem := range r.MembershipsInput {
			incidentRoleID := new(string)
			if !membershipsInputItem.IncidentRoleID.IsUnknown() && !membershipsInputItem.IncidentRoleID.IsNull() {
				*incidentRoleID = membershipsInputItem.IncidentRoleID.ValueString()
			} else {
				incidentRoleID = nil
			}
			scheduleID := new(string)
			if !membershipsInputItem.ScheduleID.IsUnknown() && !membershipsInputItem.ScheduleID.IsNull() {
				*scheduleID = membershipsInputItem.ScheduleID.ValueString()
			} else {
				scheduleID = nil
			}
			userID := new(string)
	...
	var msTeamsChannelInput *shared.CreateTeamMsTeamsChannelInput
	if r.MsTeamsChannelInput != nil {
		var channelID string
		channelID = r.MsTeamsChannelInput.ChannelID.ValueString()

		var msTeamID string
		msTeamID = r.MsTeamsChannelInput.MsTeamID.ValueString()

		msTeamsChannelInput = &shared.CreateTeamMsTeamsChannelInput{
			ChannelID: channelID,
			MsTeamID:  msTeamID,
		}
	}
...
func (r *TeamEntityResourceModel) ToSharedUpdateTeam(ctx context.Context) (*shared.UpdateTeam, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	var membershipsInput []shared.UpdateTeamMembershipsInput
	if r.MembershipsInput != nil {
		membershipsInput = make([]shared.UpdateTeamMembershipsInput, 0, len(r.MembershipsInput))
		for _, membershipsInputItem := range r.MembershipsInput {
			incidentRoleID := new(string)
			if !membershipsInputItem.IncidentRoleID.IsUnknown() && !membershipsInputItem.IncidentRoleID.IsNull() {
				*incidentRoleID = membershipsInputItem.IncidentRoleID.ValueString()
	...
	var msTeamsChannelInput *shared.UpdateTeamMsTeamsChannelInput
	if r.MsTeamsChannelInput != nil {
		var channelID string
		channelID = r.MsTeamsChannelInput.ChannelID.ValueString()
		...
		msTeamsChannelInput = &shared.UpdateTeamMsTeamsChannelInput{
			ChannelID: channelID,
			MsTeamID:  msTeamID,
		}
	}
...
func (r *TeamEntityResourceModel) ToOperationsUpdateTeamRequest(ctx context.Context) (*operations.UpdateTeamRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TeamEntityResourceModel) ToOperationsGetTeamRequest(ctx context.Context) (*operations.GetTeamRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TeamEntityResourceModel) ToOperationsDeleteTeamRequest(ctx context.Context) (*operations.DeleteTeamRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TeamEntityResourceModel) RefreshFromSharedTeamEntity(ctx context.Context, resp *shared.TeamEntity) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		if resp.DefaultSignalsEscalationPolicy == nil {
			...
			r.DefaultSignalsEscalationPolicy = &tfTypes.NullableSuccinctEntity{}
		...
		if resp.Functionalities != nil {
			r.Functionalities = []tfTypes.FunctionalityEntityLite{}
			...
			for functionalitiesCount, functionalitiesItem := range resp.Functionalities {
				var functionalities tfTypes.FunctionalityEntityLite
				...
				if functionalitiesItem.Labels == nil {
					...
					functionalities.Labels = &tfTypes.FunctionalityEntityLiteLabels{}
				}
		...
		if resp.MsTeamsChannel == nil {
			...
			r.MsTeamsChannel = &tfTypes.NullableIntegrationsMicrosoftTeamsV2ChannelEntity{}
			...
			if resp.MsTeamsChannel.Incident == nil {
				...
				r.MsTeamsChannel.Incident = &tfTypes.NullableIncidentEntity{}
				...
				if resp.MsTeamsChannel.Incident.ContextObject == nil {
					...
					r.MsTeamsChannel.Incident.ContextObject = &tfTypes.NullableIncidentsContextObjectEntity{}
				...
				if resp.MsTeamsChannel.Incident.CreatedBy == nil {
					...
					r.MsTeamsChannel.Incident.CreatedBy = &tfTypes.NullableAuthorEntity{}
				...
				if resp.MsTeamsChannel.Incident.Functionalities != nil {
					...
					for functionalitiesCount1, functionalitiesItem1 := range resp.MsTeamsChannel.Incident.Functionalities {
						var functionalities1 tfTypes.SuccinctEntity
				...
				if resp.MsTeamsChannel.Incident.IncidentType == nil {
					...
					r.MsTeamsChannel.Incident.IncidentType = &tfTypes.NullableSuccinctEntity{}
				...
				if resp.MsTeamsChannel.Incident.Labels == nil {
					...
					r.MsTeamsChannel.Incident.Labels = &tfTypes.NullableIncidentEntityLabels{}
				}
				if resp.MsTeamsChannel.Incident.LastNote == nil {
					r.MsTeamsChannel.Incident.LastNote = nil
				} else {
					r.MsTeamsChannel.Incident.LastNote = &tfTypes.NullableEventNoteEntity{}
				...
				if resp.MsTeamsChannel.Incident.Organization == nil {
					...
					r.MsTeamsChannel.Incident.Organization = &tfTypes.NullableOrganizationEntity{}
				...
				if resp.MsTeamsChannel.Incident.SeverityConditionObject == nil {
					...
					r.MsTeamsChannel.Incident.SeverityConditionObject = &tfTypes.NullableSeverityMatrixConditionEntity{}
				...
				if resp.MsTeamsChannel.Incident.SeverityImpactObject == nil {
					...
					r.MsTeamsChannel.Incident.SeverityImpactObject = &tfTypes.NullableSeverityMatrixImpactEntity{}
				...
				if resp.MsTeamsChannel.Incident.TeamAssignments != nil {
					r.MsTeamsChannel.Incident.TeamAssignments = []tfTypes.IncidentsTeamAssignmentEntityLite{}
				...
				if resp.MsTeamsChannel.Incident.Ticket == nil {
					...
					r.MsTeamsChannel.Incident.Ticket = &tfTypes.NullableTicketingTicketEntity{}
					...
					if resp.MsTeamsChannel.Incident.Ticket.CreatedBy == nil {
						...
						r.MsTeamsChannel.Incident.Ticket.CreatedBy = &tfTypes.NullableAuthorEntity{}
					...
					if resp.MsTeamsChannel.Incident.Ticket.Link == nil {
						...
						r.MsTeamsChannel.Incident.Ticket.Link = &tfTypes.NullableAttachmentsLinkEntity{}
					...
					if resp.MsTeamsChannel.Incident.Ticket.Priority == nil {
						...
						r.MsTeamsChannel.Incident.Ticket.Priority = &tfTypes.NullableTicketingPriorityEntity{}
		...
		if resp.OwnedChecklistTemplates != nil {
			r.OwnedChecklistTemplates = []tfTypes.ChecklistTemplateEntity{}
		...
		if resp.OwnedFunctionalities != nil {
			r.OwnedFunctionalities = []tfTypes.FunctionalityEntityLite{}
		...
		if resp.OwnedServices != nil {
			r.OwnedServices = []tfTypes.ServiceEntityLite{}
		...
		if resp.RespondingServices != nil {
			r.RespondingServices = []tfTypes.ServiceEntityLite{}
		...
		if resp.Services != nil {
			...
			for servicesCount1, servicesItem1 := range resp.Services {
				var services1 tfTypes.ServiceEntityLite
				...
				if servicesItem1.Labels == nil {
					...
					services1.Labels = &tfTypes.ServiceEntityLiteLabels{}
				}
		...
		if resp.SlackChannel == nil {
			...
			r.SlackChannel = &tfTypes.NullableIntegrationsSlackSlackChannelEntity{}
