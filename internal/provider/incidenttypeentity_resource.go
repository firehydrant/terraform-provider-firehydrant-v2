...
var _ resource.Resource = &IncidentTypeEntityResource{}
var _ resource.ResourceWithImportState = &IncidentTypeEntityResource{}

func NewIncidentTypeEntityResource() resource.Resource {
	return &IncidentTypeEntityResource{}
}

// IncidentTypeEntityResource defines the resource implementation.
type IncidentTypeEntityResource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// IncidentTypeEntityResourceModel describes the resource data model.
type IncidentTypeEntityResourceModel struct {
	CreatedAt      types.String                                            `tfsdk:"created_at"`
	Description    types.String                                            `tfsdk:"description"`
	ID             types.String                                            `tfsdk:"id"`
	Name           types.String                                            `tfsdk:"name"`
	Template       tfTypes.CreateIncidentTypeTemplate                      `tfsdk:"template"`
	TemplateValues *tfTypes.NullableIncidentTypeEntityTemplateValuesEntity `tfsdk:"template_values"`
	UpdatedAt      types.String                                            `tfsdk:"updated_at"`
}

func (r *IncidentTypeEntityResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_incident_type_entity"
}

func (r *IncidentTypeEntityResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "IncidentTypeEntity Resource",
...
func (r *IncidentTypeEntityResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *IncidentTypeEntityResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *IncidentTypeEntityResourceModel
	...
	request, requestDiags := data.ToSharedCreateIncidentType(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.IncidentSettings.CreateIncidentType(ctx, *request)
	if err != nil {
...
func (r *IncidentTypeEntityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *IncidentTypeEntityResourceModel
...
func (r *IncidentTypeEntityResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *IncidentTypeEntityResourceModel
	var plan types.Object
	...
	request, requestDiags := data.ToOperationsUpdateIncidentTypeRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.IncidentSettings.UpdateIncidentType(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *IncidentTypeEntityResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *IncidentTypeEntityResourceModel
	var item types.Object
	...
	request, requestDiags := data.ToOperationsDeleteIncidentTypeRequest(ctx)
	resp.Diagnostics.Append(requestDiags...)

	if resp.Diagnostics.HasError() {
		return
	}
	res, err := r.client.IncidentSettings.DeleteIncidentType(ctx, *request)
	if err != nil {
		resp.Diagnostics.AddError("failure to invoke API", err.Error())
		if res != nil && res.RawResponse != nil {
			resp.Diagnostics.AddError("unexpected http request/response", debugResponse(res.RawResponse))
...
func (r *IncidentTypeEntityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
