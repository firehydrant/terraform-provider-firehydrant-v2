...
var _ datasource.DataSource = &TeamEntityDataSource{}
var _ datasource.DataSourceWithConfigure = &TeamEntityDataSource{}

func NewTeamEntityDataSource() datasource.DataSource {
	return &TeamEntityDataSource{}
}

// TeamEntityDataSource is the data source implementation.
type TeamEntityDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// TeamEntityDataSourceModel describes the data model.
type TeamEntityDataSourceModel struct {
	...
	Lite                           types.Bool                                                 `queryParam:"style=form,explode=true,name=lite" tfsdk:"lite"`
...
func (r *TeamEntityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_team_entity"
}

// Schema defines the schema for the data source.
func (r *TeamEntityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "TeamEntity DataSource",
...
func (r *TeamEntityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *TeamEntityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *TeamEntityDataSourceModel
