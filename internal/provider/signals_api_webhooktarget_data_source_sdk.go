...
func (r *SignalsAPIWebhookTargetDataSourceModel) RefreshFromSharedSignalsAPIWebhookTarget(ctx context.Context, resp *shared.SignalsAPIWebhookTarget) diag.Diagnostics {
...
func (r *SignalsAPIWebhookTargetDataSourceModel) ToOperationsGetSignalsWebhookTargetRequest(ctx context.Context) (*operations.GetSignalsWebhookTargetRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
