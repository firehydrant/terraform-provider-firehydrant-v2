...
var _ datasource.DataSource = &TicketingTicketEntityDataSource{}
var _ datasource.DataSourceWithConfigure = &TicketingTicketEntityDataSource{}

func NewTicketingTicketEntityDataSource() datasource.DataSource {
	return &TicketingTicketEntityDataSource{}
}

// TicketingTicketEntityDataSource is the data source implementation.
type TicketingTicketEntityDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// TicketingTicketEntityDataSourceModel describes the data model.
type TicketingTicketEntityDataSourceModel struct {
...
func (r *TicketingTicketEntityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_ticketing_ticket_entity"
}

// Schema defines the schema for the data source.
func (r *TicketingTicketEntityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "TicketingTicketEntity DataSource",
...
func (r *TicketingTicketEntityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *TicketingTicketEntityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *TicketingTicketEntityDataSourceModel
