...
var _ datasource.DataSource = &SignalsAPIEscalationPolicyDataSource{}
var _ datasource.DataSourceWithConfigure = &SignalsAPIEscalationPolicyDataSource{}

func NewSignalsAPIEscalationPolicyDataSource() datasource.DataSource {
	return &SignalsAPIEscalationPolicyDataSource{}
}

// SignalsAPIEscalationPolicyDataSource is the data source implementation.
type SignalsAPIEscalationPolicyDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// SignalsAPIEscalationPolicyDataSourceModel describes the data model.
type SignalsAPIEscalationPolicyDataSourceModel struct {
	...
	Steps                        []tfTypes.SignalsAPIEscalationPolicyStep               `tfsdk:"steps"`
	TeamID                       types.String                                           `tfsdk:"team_id"`
	UpdatedAt                    types.String                                           `tfsdk:"updated_at"`
}

// Metadata returns the data source type name.
func (r *SignalsAPIEscalationPolicyDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_signals_api_escalation_policy"
}

// Schema defines the schema for the data source.
func (r *SignalsAPIEscalationPolicyDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "SignalsAPIEscalationPolicy DataSource",
...
func (r *SignalsAPIEscalationPolicyDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *SignalsAPIEscalationPolicyDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *SignalsAPIEscalationPolicyDataSourceModel
