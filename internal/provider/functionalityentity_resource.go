...
var _ resource.Resource = &FunctionalityEntityResource{}
var _ resource.ResourceWithImportState = &FunctionalityEntityResource{}

func NewFunctionalityEntityResource() resource.Resource {
	return &FunctionalityEntityResource{}
}

// FunctionalityEntityResource defines the resource implementation.
type FunctionalityEntityResource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// FunctionalityEntityResourceModel describes the resource data model.
type FunctionalityEntityResourceModel struct {
...
func (r *FunctionalityEntityResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_functionality_entity"
}

func (r *FunctionalityEntityResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "FunctionalityEntity Resource",
...
func (r *FunctionalityEntityResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *FunctionalityEntityResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *FunctionalityEntityResourceModel
	...
	resp.Diagnostics.Append(data.RefreshFromSharedFunctionalityEntity(ctx, res1.FunctionalityEntity)...)
...
func (r *FunctionalityEntityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *FunctionalityEntityResourceModel
...
func (r *FunctionalityEntityResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *FunctionalityEntityResourceModel
	var plan types.Object
...
func (r *FunctionalityEntityResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *FunctionalityEntityResourceModel
	var item types.Object
...
func (r *FunctionalityEntityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
