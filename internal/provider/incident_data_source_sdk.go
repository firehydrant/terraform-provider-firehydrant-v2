...
func (r *IncidentDataSourceModel) RefreshFromSharedIncident(ctx context.Context, resp *shared.Incident) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Labels == nil {
			...
			r.Labels = &tfTypes.IncidentLabels{}
		}
...
func (r *IncidentDataSourceModel) ToOperationsGetIncidentRequest(ctx context.Context) (*operations.GetIncidentRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
