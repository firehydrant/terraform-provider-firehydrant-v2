...
func (r *SignalsAPIGroupingDataSourceModel) RefreshFromSharedSignalsAPIGrouping(ctx context.Context, resp *shared.SignalsAPIGrouping) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Strategy == nil {
			...
			r.Strategy = &tfTypes.NullableSignalsAPIGroupingStrategy{}
			if resp.Strategy.Substring == nil {
				r.Strategy.Substring = nil
			} else {
				r.Strategy.Substring = &tfTypes.NullableSignalsAPIGroupingStrategySubstring{}
...
func (r *SignalsAPIGroupingDataSourceModel) ToOperationsGetSignalsAlertGroupingConfigurationRequest(ctx context.Context) (*operations.GetSignalsAlertGroupingConfigurationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
