...
type NullableTicketingTicket struct {
	Assignees                []Author                            `tfsdk:"assignees"`
	Attachments              []NullableTicketingTicketAttachment `tfsdk:"attachments"`
	...
	Link                     *NullableAttachmentsLink            `tfsdk:"link"`
	Priority                 *NullableTicketingPriority          `tfsdk:"priority"`
