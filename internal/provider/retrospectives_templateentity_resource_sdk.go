...
func (r *RetrospectivesTemplateEntityResourceModel) ToSharedCreateRetrospectiveTemplate(ctx context.Context) (*shared.CreateRetrospectiveTemplate, diag.Diagnostics) {
...
func (r *RetrospectivesTemplateEntityResourceModel) ToSharedUpdateRetrospectiveTemplate(ctx context.Context) (*shared.UpdateRetrospectiveTemplate, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *RetrospectivesTemplateEntityResourceModel) ToOperationsUpdateRetrospectiveTemplateRequest(ctx context.Context) (*operations.UpdateRetrospectiveTemplateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *RetrospectivesTemplateEntityResourceModel) ToOperationsGetRetrospectiveTemplateRequest(ctx context.Context) (*operations.GetRetrospectiveTemplateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *RetrospectivesTemplateEntityResourceModel) ToOperationsDeleteRetrospectiveTemplateRequest(ctx context.Context) (*operations.DeleteRetrospectiveTemplateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *RetrospectivesTemplateEntityResourceModel) RefreshFromSharedRetrospectivesTemplateEntity(ctx context.Context, resp *shared.RetrospectivesTemplateEntity) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		r.Description = types.StringPointerValue(resp.Description)
		if resp.Fields != nil {
			r.Fields = []tfTypes.RetrospectivesFieldEntity{}
			if len(r.Fields) > len(resp.Fields) {
				r.Fields = r.Fields[:len(resp.Fields)]
			}
			for fieldsCount, fieldsItem := range resp.Fields {
				var fields tfTypes.RetrospectivesFieldEntity
		...
		if resp.Sections != nil {
			r.Sections = []tfTypes.RetrospectivesTemplateEntityIncidentSectionEntity{}
			...
			for sectionsCount, sectionsItem := range resp.Sections {
				var sections tfTypes.RetrospectivesTemplateEntityIncidentSectionEntity
