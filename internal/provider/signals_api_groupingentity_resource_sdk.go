...
func (r *SignalsAPIGroupingEntityResourceModel) ToSharedCreateSignalsAlertGroupingConfiguration(ctx context.Context) (*shared.CreateSignalsAlertGroupingConfiguration, diag.Diagnostics) {
...
func (r *SignalsAPIGroupingEntityResourceModel) ToSharedUpdateSignalsAlertGroupingConfiguration(ctx context.Context) (*shared.UpdateSignalsAlertGroupingConfiguration, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIGroupingEntityResourceModel) ToOperationsUpdateSignalsAlertGroupingConfigurationRequest(ctx context.Context) (*operations.UpdateSignalsAlertGroupingConfigurationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIGroupingEntityResourceModel) ToOperationsGetSignalsAlertGroupingConfigurationRequest(ctx context.Context) (*operations.GetSignalsAlertGroupingConfigurationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIGroupingEntityResourceModel) ToOperationsDeleteSignalsAlertGroupingConfigurationRequest(ctx context.Context) (*operations.DeleteSignalsAlertGroupingConfigurationRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIGroupingEntityResourceModel) RefreshFromSharedSignalsAPIGroupingEntity(ctx context.Context, resp *shared.SignalsAPIGroupingEntity) diag.Diagnostics {
	var diags diag.Diagnostics
