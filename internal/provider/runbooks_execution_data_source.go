...
var _ datasource.DataSource = &RunbooksExecutionDataSource{}
var _ datasource.DataSourceWithConfigure = &RunbooksExecutionDataSource{}

func NewRunbooksExecutionDataSource() datasource.DataSource {
	return &RunbooksExecutionDataSource{}
}

// RunbooksExecutionDataSource is the data source implementation.
type RunbooksExecutionDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// RunbooksExecutionDataSourceModel describes the data model.
type RunbooksExecutionDataSourceModel struct {
	CreatedAt           types.String                                  `tfsdk:"created_at"`
	CreatedBy           types.String                                  `tfsdk:"created_by"`
	ExecutedFor         *tfTypes.NullableRunbooksExecutionExecutedFor `tfsdk:"executed_for"`
	HasBeenRerun        types.Bool                                    `tfsdk:"has_been_rerun"`
	ID                  types.String                                  `tfsdk:"id"`
	Runbook             *tfTypes.NullableSlimRunbook                  `tfsdk:"runbook"`
...
func (r *RunbooksExecutionDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_runbooks_execution"
}

// Schema defines the schema for the data source.
func (r *RunbooksExecutionDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "RunbooksExecution DataSource",
			...
			"steps": schema.SingleNestedAttribute{
				...
				Attributes: map[string]schema.Attribute{
					...
					"conference_bridge": schema.SingleNestedAttribute{
						...
						Description: `Incidents_ConferenceBridge model`,
					},
...
func (r *RunbooksExecutionDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *RunbooksExecutionDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *RunbooksExecutionDataSourceModel
	...
	if !(res.RunbooksExecution != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedRunbooksExecution(ctx, res.RunbooksExecution)...)
