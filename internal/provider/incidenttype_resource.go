...
type IncidentTypeResourceModel struct {
	...
	TemplateValues *tfTypes.NullableIncidentTypeTemplateValues `tfsdk:"template_values"`
...
func (r *IncidentTypeResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	...
	if !(res.IncidentType != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedIncidentType(ctx, res.IncidentType)...)
