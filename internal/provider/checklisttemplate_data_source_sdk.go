...
func (r *ChecklistTemplateDataSourceModel) RefreshFromSharedChecklistTemplate(ctx context.Context, resp *shared.ChecklistTemplate) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		if resp.Checks != nil {
			r.Checks = []tfTypes.ChecklistCheck1{}
...
func (r *ChecklistTemplateDataSourceModel) ToOperationsGetChecklistTemplateRequest(ctx context.Context) (*operations.GetChecklistTemplateRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
