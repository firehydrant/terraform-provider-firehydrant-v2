...
func (r *IncidentEventEntityDataSourceModel) ToOperationsGetIncidentEventRequest(ctx context.Context) (*operations.GetIncidentEventRequest, diag.Diagnostics) {
...
func (r *IncidentEventEntityDataSourceModel) RefreshFromSharedIncidentEventEntity(ctx context.Context, resp *shared.IncidentEventEntity) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		if resp.Author == nil {
			...
			r.Author = &tfTypes.NullableAuthorEntity{}
		...
		if resp.Data == nil {
			...
			r.Data = &tfTypes.IncidentEventEntityData{}
		}
		...
		if resp.Votes == nil {
			...
			r.Votes = &tfTypes.NullableVotesEntity{}
