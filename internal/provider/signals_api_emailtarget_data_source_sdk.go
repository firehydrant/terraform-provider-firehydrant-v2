...
func (r *SignalsAPIEmailTargetDataSourceModel) RefreshFromSharedSignalsAPIEmailTarget(ctx context.Context, resp *shared.SignalsAPIEmailTarget) diag.Diagnostics {
...
func (r *SignalsAPIEmailTargetDataSourceModel) ToOperationsGetSignalsEmailTargetRequest(ctx context.Context) (*operations.GetSignalsEmailTargetRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
