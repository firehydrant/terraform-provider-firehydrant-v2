...
var _ datasource.DataSource = &ScheduledMaintenancesDataSource{}
var _ datasource.DataSourceWithConfigure = &ScheduledMaintenancesDataSource{}

func NewScheduledMaintenancesDataSource() datasource.DataSource {
	return &ScheduledMaintenancesDataSource{}
}

// ScheduledMaintenancesDataSource is the data source implementation.
type ScheduledMaintenancesDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// ScheduledMaintenancesDataSourceModel describes the data model.
type ScheduledMaintenancesDataSourceModel struct {
	...
	Labels                          *tfTypes.NullableIncidentLabels       `tfsdk:"labels"`
	...
	RetroExports                    []tfTypes.NullableIncidentRetroExport `tfsdk:"retro_exports"`
...
func (r *ScheduledMaintenancesDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_scheduled_maintenances"
}

// Schema defines the schema for the data source.
func (r *ScheduledMaintenancesDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ScheduledMaintenances DataSource",
...
func (r *ScheduledMaintenancesDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ScheduledMaintenancesDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ScheduledMaintenancesDataSourceModel
