...
func (r *IncidentRoleDataSourceModel) RefreshFromSharedIncidentRole(ctx context.Context, resp *shared.IncidentRole) diag.Diagnostics {
...
func (r *IncidentRoleDataSourceModel) ToOperationsGetIncidentRoleRequest(ctx context.Context) (*operations.GetIncidentRoleRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
