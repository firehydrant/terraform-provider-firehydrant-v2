...
func (r *UserEntityDataSourceModel) ToOperationsGetUserRequest(ctx context.Context) (*operations.GetUserRequest, diag.Diagnostics) {
...
func (r *UserEntityDataSourceModel) RefreshFromSharedUserEntity(ctx context.Context, resp *shared.UserEntity) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		if resp.SignalsNotificationPolicyCompliance != nil {
			r.SignalsNotificationPolicyCompliance = []tfTypes.SignalsAPINotificationPolicyItemComplianceEntity{}
