...
func (r *IncidentResourceModel) RefreshFromSharedIncident(ctx context.Context, resp *shared.Incident) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.ConferenceBridges != nil {
			r.ConferenceBridges = []tfTypes.IncidentsConferenceBridge{}
		...
		if resp.ContextObject == nil {
			...
			r.ContextObject = &tfTypes.NullableIncidentsContextObject{}
		...
		if resp.FieldRequirements != nil {
			r.FieldRequirements = []tfTypes.IncidentFieldRequirement{}
		...
		if resp.Functionalities != nil {
			r.Functionalities = []tfTypes.Succinct{}
		...
		if resp.Impacts != nil {
			r.Impacts = []tfTypes.IncidentsImpact{}
		...
		if resp.IncidentChannels != nil {
			r.IncidentChannels = []tfTypes.IncidentsChannel{}
		...
		if resp.IncidentTickets != nil {
			r.IncidentTickets = []tfTypes.TicketingTicket{}
		...
		if resp.LastNote == nil {
			...
			r.LastNote = &tfTypes.NullableEventNote{}
			r.LastNote.Body = types.StringPointerValue(resp.LastNote.Body)
			if resp.LastNote.Conversations != nil {
				r.LastNote.Conversations = []tfTypes.ConversationsAPIReference{}
			...
			if resp.LastNote.StatusPages != nil {
				r.LastNote.StatusPages = []tfTypes.IncidentsStatusPage{}
		...
		if resp.LifecycleMeasurements != nil {
			r.LifecycleMeasurements = []tfTypes.IncidentsLifecycleMeasurement{}
		...
		if resp.LifecyclePhases != nil {
			r.LifecyclePhases = []tfTypes.IncidentsLifecyclePhase{}
		...
		if resp.Milestones != nil {
			r.Milestones = []tfTypes.IncidentsMilestone{}
		...
		if resp.Organization == nil {
			...
			r.Organization = &tfTypes.NullableOrganization{}
		...
		if resp.RoleAssignments != nil {
			r.RoleAssignments = []tfTypes.IncidentsRoleAssignment{}
		...
		if resp.SeverityConditionObject == nil {
			...
			r.SeverityConditionObject = &tfTypes.NullableSeverityMatrixCondition{}
		...
		if resp.SeverityImpactObject == nil {
			...
			r.SeverityImpactObject = &tfTypes.NullableSeverityMatrixImpact{}
		...
		if resp.StatusPages != nil {
			r.StatusPages = []tfTypes.IncidentsStatusPage{}
		...
		if resp.TeamAssignments != nil {
			r.TeamAssignments = []tfTypes.IncidentsTeamAssignmentLite{}
		...
		if resp.Ticket == nil {
			...
			r.Ticket = &tfTypes.NullableTicketingTicket{}
			if resp.Ticket.Assignees != nil {
				r.Ticket.Assignees = []tfTypes.Author{}
			...
			if resp.Ticket.CreatedBy == nil {
				...
				r.Ticket.CreatedBy = &tfTypes.NullableAuthor{}
			...
			if resp.Ticket.Link == nil {
				...
				r.Ticket.Link = &tfTypes.NullableAttachmentsLink{}
			...
			if resp.Ticket.Priority == nil {
				...
				r.Ticket.Priority = &tfTypes.NullableTicketingPriority{}
...
func (r *IncidentResourceModel) ToOperationsGetIncidentRequest(ctx context.Context) (*operations.GetIncidentRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *IncidentResourceModel) ToSharedCreateIncident(ctx context.Context) (*shared.CreateIncident, diag.Diagnostics) {
	var diags diag.Diagnostics
