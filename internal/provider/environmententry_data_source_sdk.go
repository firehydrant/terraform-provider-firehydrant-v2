...
func (r *EnvironmentEntryDataSourceModel) RefreshFromSharedEnvironmentEntry(ctx context.Context, resp *shared.EnvironmentEntry) diag.Diagnostics {
...
func (r *EnvironmentEntryDataSourceModel) ToOperationsGetEnvironmentRequest(ctx context.Context) (*operations.GetEnvironmentRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
