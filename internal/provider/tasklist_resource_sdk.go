...
func (r *TaskListResourceModel) ToOperationsDeleteTaskListRequest(ctx context.Context) (*operations.DeleteTaskListRequest, diag.Diagnostics) {
...
func (r *TaskListResourceModel) ToOperationsGetTaskListRequest(ctx context.Context) (*operations.GetTaskListRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TaskListResourceModel) ToOperationsUpdateTaskListRequest(ctx context.Context) (*operations.UpdateTaskListRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TaskListResourceModel) ToSharedCreateTaskList(ctx context.Context) (*shared.CreateTaskList, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *TaskListResourceModel) ToSharedUpdateTaskList(ctx context.Context) (*shared.UpdateTaskList, diag.Diagnostics) {
	var diags diag.Diagnostics
