...
var _ resource.Resource = &ScheduledMaintenanceEntityResource{}
var _ resource.ResourceWithImportState = &ScheduledMaintenanceEntityResource{}

func NewScheduledMaintenanceEntityResource() resource.Resource {
	return &ScheduledMaintenanceEntityResource{}
}

// ScheduledMaintenanceEntityResource defines the resource implementation.
type ScheduledMaintenanceEntityResource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// ScheduledMaintenanceEntityResourceModel describes the resource data model.
type ScheduledMaintenanceEntityResourceModel struct {
	CreatedAt        types.String                                         `tfsdk:"created_at"`
	Description      types.String                                         `tfsdk:"description"`
	EndsAt           types.String                                         `tfsdk:"ends_at"`
	ID               types.String                                         `tfsdk:"id"`
	Impacts          []tfTypes.ScheduledMaintenancesImpactEntity          `tfsdk:"impacts"`
	...
	StatusPages      []tfTypes.ScheduledMaintenancesStatusPageEntity      `tfsdk:"status_pages"`
	StatusPagesInput []tfTypes.CreateScheduledMaintenanceStatusPagesInput `tfsdk:"status_pages_input"`
	Summary          types.String                                         `tfsdk:"summary"`
	UpdatedAt        types.String                                         `tfsdk:"updated_at"`
}

func (r *ScheduledMaintenanceEntityResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_scheduled_maintenance_entity"
}

func (r *ScheduledMaintenanceEntityResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ScheduledMaintenanceEntity Resource",
...
func (r *ScheduledMaintenanceEntityResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ScheduledMaintenanceEntityResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ScheduledMaintenanceEntityResourceModel
...
func (r *ScheduledMaintenanceEntityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ScheduledMaintenanceEntityResourceModel
...
func (r *ScheduledMaintenanceEntityResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ScheduledMaintenanceEntityResourceModel
	var plan types.Object
...
func (r *ScheduledMaintenanceEntityResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ScheduledMaintenanceEntityResourceModel
	var item types.Object
...
func (r *ScheduledMaintenanceEntityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
