...
func (r *SignalsAPIOnCallScheduleDataSourceModel) RefreshFromSharedSignalsAPIOnCallSchedule(ctx context.Context, resp *shared.SignalsAPIOnCallSchedule) diag.Diagnostics {
...
func (r *SignalsAPIOnCallScheduleDataSourceModel) ToOperationsGetTeamOnCallScheduleRequest(ctx context.Context) (*operations.GetTeamOnCallScheduleRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
