...
func (r *ServiceEntityResourceModel) ToSharedCreateService(ctx context.Context) (*shared.CreateService, diag.Diagnostics) {
	...
	var externalResourcesInput []shared.CreateServiceExternalResourcesInput
	if r.ExternalResourcesInput != nil {
		externalResourcesInput = make([]shared.CreateServiceExternalResourcesInput, 0, len(r.ExternalResourcesInput))
		for _, externalResourcesInputItem := range r.ExternalResourcesInput {
			...
			externalResourcesInput = append(externalResourcesInput, shared.CreateServiceExternalResourcesInput{
				ConnectionType: connectionType,
				RemoteID:       remoteID,
			})
		}
	}
	var functionalitiesInput []shared.CreateServiceFunctionalitiesInput
	if r.FunctionalitiesInput != nil {
		functionalitiesInput = make([]shared.CreateServiceFunctionalitiesInput, 0, len(r.FunctionalitiesInput))
		for _, functionalitiesInputItem := range r.FunctionalitiesInput {
			id := new(string)
			if !functionalitiesInputItem.ID.IsUnknown() && !functionalitiesInputItem.ID.IsNull() {
				*id = functionalitiesInputItem.ID.ValueString()
			} else {
				id = nil
			}
			summary := new(string)
			if !functionalitiesInputItem.Summary.IsUnknown() && !functionalitiesInputItem.Summary.IsNull() {
				*summary = functionalitiesInputItem.Summary.ValueString()
			} else {
				summary = nil
			}
			functionalitiesInput = append(functionalitiesInput, shared.CreateServiceFunctionalitiesInput{
				ID:      id,
				Summary: summary,
			})
		}
	...
	var linksInput []shared.CreateServiceLinksInput
	if r.LinksInput != nil {
		linksInput = make([]shared.CreateServiceLinksInput, 0, len(r.LinksInput))
		for _, linksInputItem := range r.LinksInput {
			...
			linksInput = append(linksInput, shared.CreateServiceLinksInput{
				HrefURL: hrefURL,
				IconURL: iconURL,
				Name:    name,
			})
	...
	var ownerInput *shared.CreateServiceOwnerInput
	if r.OwnerInput != nil {
		var id1 string
		id1 = r.OwnerInput.ID.ValueString()

		ownerInput = &shared.CreateServiceOwnerInput{
			ID: id1,
		}
	}
	serviceTier := new(shared.CreateServiceServiceTier)
	if !r.ServiceTier.IsUnknown() && !r.ServiceTier.IsNull() {
		*serviceTier = shared.CreateServiceServiceTier(r.ServiceTier.ValueInt32())
	} else {
		serviceTier = nil
	}
	var teamsInput []shared.CreateServiceTeamsInput
	if r.TeamsInput != nil {
		teamsInput = make([]shared.CreateServiceTeamsInput, 0, len(r.TeamsInput))
		for _, teamsInputItem := range r.TeamsInput {
			var id2 string
			id2 = teamsInputItem.ID.ValueString()

			teamsInput = append(teamsInput, shared.CreateServiceTeamsInput{
				ID: id2,
			})
		}
	}
	out := shared.CreateService{
		...
		FunctionalitiesInput:   functionalitiesInput,
		Labels:                 labels,
...
func (r *ServiceEntityResourceModel) ToSharedUpdateService(ctx context.Context) (*shared.UpdateService, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	var externalResourcesInput []shared.UpdateServiceExternalResourcesInput
	if r.ExternalResourcesInput != nil {
		externalResourcesInput = make([]shared.UpdateServiceExternalResourcesInput, 0, len(r.ExternalResourcesInput))
		for _, externalResourcesInputItem := range r.ExternalResourcesInput {
			connectionType := new(string)
			if !externalResourcesInputItem.ConnectionType.IsUnknown() && !externalResourcesInputItem.ConnectionType.IsNull() {
				*connectionType = externalResourcesInputItem.ConnectionType.ValueString()
			...
			externalResourcesInput = append(externalResourcesInput, shared.UpdateServiceExternalResourcesInput{
				ConnectionType: connectionType,
				RemoteID:       remoteID,
			})
		}
	}
	var functionalitiesInput []shared.UpdateServiceFunctionalitiesInput
	if r.FunctionalitiesInput != nil {
		functionalitiesInput = make([]shared.UpdateServiceFunctionalitiesInput, 0, len(r.FunctionalitiesInput))
		for _, functionalitiesInputItem := range r.FunctionalitiesInput {
			id := new(string)
			if !functionalitiesInputItem.ID.IsUnknown() && !functionalitiesInputItem.ID.IsNull() {
				*id = functionalitiesInputItem.ID.ValueString()
			...
			// ServiceEntity#update.functionalities_input.removeServiceEntity#update.functionalities_input.remove impedance mismatch: boolean != stringtrace=["ServiceEntity#create.req.functionalities_input.[].summary"]
			var remove *bool
			summary := new(string)
			if !functionalitiesInputItem.Summary.IsUnknown() && !functionalitiesInputItem.Summary.IsNull() {
				*summary = functionalitiesInputItem.Summary.ValueString()
			...
			functionalitiesInput = append(functionalitiesInput, shared.UpdateServiceFunctionalitiesInput{
				ID:      id,
				Remove:  remove,
				Summary: summary,
			})
	...
	var linksInput []shared.UpdateServiceLinksInput
	if r.LinksInput != nil {
		linksInput = make([]shared.UpdateServiceLinksInput, 0, len(r.LinksInput))
		for _, linksInputItem := range r.LinksInput {
			var hrefURL string
			hrefURL = linksInputItem.HrefURL.ValueString()
			...
			if !linksInputItem.Name.IsUnknown() && !linksInputItem.Name.IsNull() {
				*id1 = linksInputItem.Name.ValueString()
			} else {
				id1 = nil
			}
			var name string
			...
			linksInput = append(linksInput, shared.UpdateServiceLinksInput{
				HrefURL: hrefURL,
				IconURL: iconURL,
				ID:      id1,
				Name:    name,
	...
	var ownerInput *shared.UpdateServiceOwnerInput
	if r.OwnerInput != nil {
		var id2 string
		id2 = r.OwnerInput.ID.ValueString()

		ownerInput = &shared.UpdateServiceOwnerInput{
			ID: id2,
		}
	}
	serviceTier := new(shared.UpdateServiceServiceTier)
	if !r.ServiceTier.IsUnknown() && !r.ServiceTier.IsNull() {
		*serviceTier = shared.UpdateServiceServiceTier(r.ServiceTier.ValueInt32())
	} else {
		serviceTier = nil
	}
	var teamsInput []shared.UpdateServiceTeamsInput
	if r.TeamsInput != nil {
		teamsInput = make([]shared.UpdateServiceTeamsInput, 0, len(r.TeamsInput))
		for _, teamsInputItem := range r.TeamsInput {
			var id3 string
			id3 = teamsInputItem.ID.ValueString()

			teamsInput = append(teamsInput, shared.UpdateServiceTeamsInput{
				ID: id3,
			})
		}
	}
	out := shared.UpdateService{
		AlertOnAdd:             alertOnAdd,
		AutoAddRespondingTeam:  autoAddRespondingTeam,
		Description:            description,
		ExternalResourcesInput: externalResourcesInput,
...
func (r *ServiceEntityResourceModel) ToOperationsUpdateServiceRequest(ctx context.Context) (*operations.UpdateServiceRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var serviceID string
	serviceID = r.ID.ValueString()

	updateService, updateServiceDiags := r.ToSharedUpdateService(ctx)
	diags.Append(updateServiceDiags...)

	if diags.HasError() {
		return nil, diags
	}

	out := operations.UpdateServiceRequest{
		ServiceID:     serviceID,
...
func (r *ServiceEntityResourceModel) ToOperationsGetServiceRequest(ctx context.Context) (*operations.GetServiceRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ServiceEntityResourceModel) ToOperationsDeleteServiceRequest(ctx context.Context) (*operations.DeleteServiceRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ServiceEntityResourceModel) RefreshFromSharedServiceEntity(ctx context.Context, resp *shared.ServiceEntity) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		if resp.ServiceTier != nil {
			r.ServiceTier = types.Int32Value(int32(*resp.ServiceTier))
		} else {
			r.ServiceTier = types.Int32Null()
		}
