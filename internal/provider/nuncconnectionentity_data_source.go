...
var _ datasource.DataSource = &NuncConnectionEntityDataSource{}
var _ datasource.DataSourceWithConfigure = &NuncConnectionEntityDataSource{}

func NewNuncConnectionEntityDataSource() datasource.DataSource {
	return &NuncConnectionEntityDataSource{}
}

// NuncConnectionEntityDataSource is the data source implementation.
type NuncConnectionEntityDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// NuncConnectionEntityDataSourceModel describes the data model.
type NuncConnectionEntityDataSourceModel struct {
...
func (r *NuncConnectionEntityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_nunc_connection_entity"
}

// Schema defines the schema for the data source.
func (r *NuncConnectionEntityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "NuncConnectionEntity DataSource",
...
func (r *NuncConnectionEntityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *NuncConnectionEntityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *NuncConnectionEntityDataSourceModel
