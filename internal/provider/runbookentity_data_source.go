...
var _ datasource.DataSource = &RunbookEntityDataSource{}
var _ datasource.DataSourceWithConfigure = &RunbookEntityDataSource{}

func NewRunbookEntityDataSource() datasource.DataSource {
	return &RunbookEntityDataSource{}
}

// RunbookEntityDataSource is the data source implementation.
type RunbookEntityDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// RunbookEntityDataSourceModel describes the data model.
type RunbookEntityDataSourceModel struct {
...
func (r *RunbookEntityDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_runbook_entity"
}

// Schema defines the schema for the data source.
func (r *RunbookEntityDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "RunbookEntity DataSource",
...
func (r *RunbookEntityDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *RunbookEntityDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *RunbookEntityDataSourceModel
