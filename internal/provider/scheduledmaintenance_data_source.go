...
var _ datasource.DataSource = &ScheduledMaintenanceDataSource{}
var _ datasource.DataSourceWithConfigure = &ScheduledMaintenanceDataSource{}

func NewScheduledMaintenanceDataSource() datasource.DataSource {
	return &ScheduledMaintenanceDataSource{}
}

// ScheduledMaintenanceDataSource is the data source implementation.
type ScheduledMaintenanceDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// ScheduledMaintenanceDataSourceModel describes the data model.
type ScheduledMaintenanceDataSourceModel struct {
	...
	Labels      *tfTypes.ScheduledMaintenanceLabels       `tfsdk:"labels"`
...
func (r *ScheduledMaintenanceDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_scheduled_maintenance"
}

// Schema defines the schema for the data source.
func (r *ScheduledMaintenanceDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ScheduledMaintenance DataSource",
...
func (r *ScheduledMaintenanceDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *ScheduledMaintenanceDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *ScheduledMaintenanceDataSourceModel
