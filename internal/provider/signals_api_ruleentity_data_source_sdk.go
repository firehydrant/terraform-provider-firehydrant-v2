...
func (r *SignalsAPIRuleEntityDataSourceModel) ToOperationsGetTeamSignalRuleRequest(ctx context.Context) (*operations.GetTeamSignalRuleRequest, diag.Diagnostics) {
...
func (r *SignalsAPIRuleEntityDataSourceModel) RefreshFromSharedSignalsAPIRuleEntity(ctx context.Context, resp *shared.SignalsAPIRuleEntity) diag.Diagnostics {
	var diags diag.Diagnostics
