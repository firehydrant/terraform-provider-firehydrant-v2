...
var _ datasource.DataSource = &PostMortemsPostMortemReportDataSource{}
var _ datasource.DataSourceWithConfigure = &PostMortemsPostMortemReportDataSource{}

func NewPostMortemsPostMortemReportDataSource() datasource.DataSource {
	return &PostMortemsPostMortemReportDataSource{}
}

// PostMortemsPostMortemReportDataSource is the data source implementation.
type PostMortemsPostMortemReportDataSource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// PostMortemsPostMortemReportDataSourceModel describes the data model.
type PostMortemsPostMortemReportDataSourceModel struct {
	AdditionalDetails []types.String                       `tfsdk:"additional_details"`
	CalendarEvents    *tfTypes.NullableCalendarsEvent      `tfsdk:"calendar_events"`
	CreatedAt         types.String                         `tfsdk:"created_at"`
	ID                types.String                         `tfsdk:"id"`
	Incident          *tfTypes.NullableIncident            `tfsdk:"incident"`
	IncidentID        types.String                         `tfsdk:"incident_id"`
	Name              types.String                         `tfsdk:"name"`
	Questions         *tfTypes.NullablePostMortemsQuestion `tfsdk:"questions"`
...
func (r *PostMortemsPostMortemReportDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_post_mortems_post_mortem_report"
}

// Schema defines the schema for the data source.
func (r *PostMortemsPostMortemReportDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "PostMortemsPostMortemReport DataSource",
...
func (r *PostMortemsPostMortemReportDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *PostMortemsPostMortemReportDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	var data *PostMortemsPostMortemReportDataSourceModel
	...
	if !(res.PostMortemsPostMortemReport != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedPostMortemsPostMortemReport(ctx, res.PostMortemsPostMortemReport)...)
