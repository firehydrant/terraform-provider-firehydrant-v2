...
var _ resource.Resource = &ServiceEntityResource{}
var _ resource.ResourceWithImportState = &ServiceEntityResource{}

func NewServiceEntityResource() resource.Resource {
	return &ServiceEntityResource{}
}

// ServiceEntityResource defines the resource implementation.
type ServiceEntityResource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// ServiceEntityResourceModel describes the resource data model.
type ServiceEntityResourceModel struct {
	...
	Checklists                []tfTypes.ChecklistTemplateEntity                `tfsdk:"checklists"`
	...
	LastImport                *tfTypes.NullableImportsImportableResourceEntity `tfsdk:"last_import"`
	Links                     []tfTypes.LinksEntity                            `tfsdk:"links"`
	LinksInput                []tfTypes.CreateServiceLinksInput                `tfsdk:"links_input"`
	ManagedBy                 types.String                                     `tfsdk:"managed_by"`
	ManagedBySettings         *tfTypes.ServiceEntityManagedBySettings          `tfsdk:"managed_by_settings"`
...
func (r *ServiceEntityResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_service_entity"
}

func (r *ServiceEntityResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "ServiceEntity Resource",
...
func (r *ServiceEntityResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *ServiceEntityResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *ServiceEntityResourceModel
	...
	resp.Diagnostics.Append(data.RefreshFromSharedServiceEntity(ctx, res.ServiceEntity)...)
	...
	resp.Diagnostics.Append(data.RefreshFromSharedServiceEntity(ctx, res1.ServiceEntity)...)
...
func (r *ServiceEntityResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *ServiceEntityResourceModel
...
func (r *ServiceEntityResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *ServiceEntityResourceModel
	var plan types.Object
...
func (r *ServiceEntityResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *ServiceEntityResourceModel
	var item types.Object
...
func (r *ServiceEntityResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
