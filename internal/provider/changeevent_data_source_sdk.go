...
func (r *ChangeEventDataSourceModel) RefreshFromSharedChangeEvent(ctx context.Context, resp *shared.ChangeEvent) diag.Diagnostics {
...
func (r *ChangeEventDataSourceModel) ToOperationsGetChangeEventRequest(ctx context.Context) (*operations.GetChangeEventRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
