...
func (p *FirehydrantProvider) Resources(ctx context.Context) []func() resource.Resource {
	return []func() resource.Resource{
		NewChangeEventEntityResource,
		NewChecklistTemplateEntityResource,
		NewEnvironmentEntryEntityResource,
		NewFunctionalityEntityResource,
		...
		NewScheduledMaintenanceEntityResource,
		NewServiceDependencyEntityResource,
		NewServiceEntityResource,
		NewSeverityEntityResource,
		NewSeverityMatrixConditionEntityResource,
		NewSignalsAPICallRouteEntityResource,
		NewSignalsAPIEmailTargetEntityResource,
		NewSignalsAPIEscalationPolicyEntityResource,
		NewSignalsAPIGroupingEntityResource,
		NewSignalsAPINotificationPolicyItemEntityResource,
		NewSignalsAPIRuleEntityResource,
		NewSignalsAPITransposerEntityResource,
		NewSignalsAPIWebhookTargetEntityResource,
		NewTaskListEntityResource,
		NewTeamEntityResource,
		NewTicketingPriorityEntityResource,
		NewTicketingTicketEntityResource,
		NewWebhooksEntitiesWebhookEntityResource,
	}
}

func (p *FirehydrantProvider) DataSources(ctx context.Context) []func() datasource.DataSource {
	return []func() datasource.DataSource{
		NewAIEntitiesIncidentSummaryEntityDataSource,
		NewAlertsAlertEntityDataSource,
		NewAudiencesEntitiesAudienceEntityDataSource,
		NewAudiencesEntitiesAudiencesEntitiesDataSource,
		NewChangeEventEntityDataSource,
		NewChecklistTemplateEntityDataSource,
		NewCurrentUsersEntitiesDataSource,
		NewEnvironmentEntryEntityDataSource,
		NewFunctionalityEntityDataSource,
		NewIncidentEntityDataSource,
		NewIncidentEventEntityDataSource,
		NewIncidentRoleEntityDataSource,
		NewIncidentsChannelEntityDataSource,
		NewIncidentsConferenceBridgeEntityDataSource,
		NewIncidentsConferenceBridgesEntitiesDataSource,
		NewIncidentsRetrospectiveFieldEntityDataSource,
		NewIncidentsRoleAssignmentEntityDataSource,
		NewIncidentTypeEntityDataSource,
		NewIntegrationsAwsCloudtrailBatchEntityDataSource,
		NewIntegrationsAwsConnectionEntityDataSource,
		NewIntegrationsIntegrationEntityDataSource,
		NewIntegrationsSlackUsergroupsEntitiesDataSource,
		NewIntegrationsSlackWorkspacesEntitiesDataSource,
		NewIntegrationsStatuspageConnectionEntityDataSource,
		NewIntegrationsStatuspagePagesEntitiesDataSource,
		NewMetricsInfrastructureMetricsesEntitiesDataSource,
		NewNuncConnectionEntityDataSource,
		NewNuncEmailSubscribersesEntitiesDataSource,
		NewOrganizationsCustomFieldDefinitionsEntitiesDataSource,
		NewPostMortemsPostMortemReportEntityDataSource,
		NewPrioritiesEntitiesDataSource,
		NewPriorityEntityDataSource,
		NewPublicAPIV1IncidentsTranscriptsEntitiesDataSource,
		NewRetrospectivesTemplateEntityDataSource,
		NewRunbookEntityDataSource,
		NewRunbooksExecutionEntityDataSource,
		NewRunbooksEntitiesDataSource,
		NewSavedSearchEntityDataSource,
		NewScheduledMaintenanceEntityDataSource,
		NewScheduledMaintenancesEntitiesDataSource,
		NewServiceDependencyEntityDataSource,
		NewServiceEntityDataSource,
		NewSeverityEntityDataSource,
		NewSeverityMatrixConditionEntityDataSource,
		NewSeverityMatrixConditionsEntitiesDataSource,
		NewSeverityMatrixImpactsEntitiesDataSource,
		NewSignalsAPICallRouteEntityDataSource,
		NewSignalsAPIEmailTargetEntityDataSource,
		NewSignalsAPIEscalationPolicyEntityDataSource,
		NewSignalsAPIGroupingEntityDataSource,
		NewSignalsAPIGroupingsEntitiesDataSource,
		NewSignalsAPINotificationPolicyItemEntityDataSource,
		NewSignalsAPIOnCallScheduleEntityDataSource,
		NewSignalsAPIOnCallShiftEntityDataSource,
		NewSignalsAPIRuleEntityDataSource,
		NewSignalsAPITransposerEntityDataSource,
		NewSignalsAPITransposersEntitiesDataSource,
		NewSignalsAPIWebhookTargetEntityDataSource,
		NewTaskListEntityDataSource,
		NewTaskListsEntitiesDataSource,
		NewTeamEntityDataSource,
		NewTicketingPrioritiesEntitiesDataSource,
		NewTicketingPriorityEntityDataSource,
		NewTicketingProjectConfigEntityDataSource,
		NewTicketingProjectFieldMapEntityDataSource,
		NewTicketingProjectInboundFieldMapEntityDataSource,
		NewTicketingProjectInboundFieldMapsEntitiesDataSource,
		NewTicketingProjectsProjectListItemEntityDataSource,
		NewTicketingProjectsProjectListItemsEntitiesDataSource,
		NewTicketingTicketEntityDataSource,
		NewTicketingTicketsEntitiesDataSource,
		NewUserEntityDataSource,
		NewWebhooksEntitiesWebhookEntityDataSource,
		NewWebhooksEntitiesWebhooksEntitiesDataSource,
	}
}
