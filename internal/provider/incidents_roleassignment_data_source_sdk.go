...
func (r *IncidentsRoleAssignmentDataSourceModel) RefreshFromSharedIncidentsRoleAssignment(ctx context.Context, resp *shared.IncidentsRoleAssignment) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.IncidentRole == nil {
			...
			r.IncidentRole = &tfTypes.NullableIncidentRole{}
		...
		if resp.User == nil {
			...
			if resp.User.SignalsNotificationPolicyCompliance != nil {
				r.User.SignalsNotificationPolicyCompliance = []tfTypes.SignalsAPINotificationPolicyItemCompliance{}
...
func (r *IncidentsRoleAssignmentDataSourceModel) ToOperationsGetIncidentUserRequest(ctx context.Context) (*operations.GetIncidentUserRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
