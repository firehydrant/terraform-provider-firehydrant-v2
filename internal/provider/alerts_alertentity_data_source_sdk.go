...
func (r *AlertsAlertEntityDataSourceModel) ToOperationsGetAlertRequest(ctx context.Context) (*operations.GetAlertRequest, diag.Diagnostics) {
...
func (r *AlertsAlertEntityDataSourceModel) RefreshFromSharedAlertsAlertEntity(ctx context.Context, resp *shared.AlertsAlertEntity) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		if resp.ChildAlerts != nil {
			r.ChildAlerts = []tfTypes.AlertsSirenAlertEntity{}
			...
			for childAlertsCount, childAlertsItem := range resp.ChildAlerts {
				var childAlerts tfTypes.AlertsSirenAlertEntity
				...
				if childAlertsItem.Labels == nil {
					...
					childAlerts.Labels = &tfTypes.AlertsSirenAlertEntityLabels{}
				}
				...
				if childAlertsItem.SignalRule == nil {
					...
					childAlerts.SignalRule = &tfTypes.NullableSignalsAPIRuleEntity{}
					...
					if childAlertsItem.SignalRule.CreatedBy == nil {
						...
						childAlerts.SignalRule.CreatedBy = &tfTypes.NullableAuthorEntity{}
					...
					if childAlertsItem.SignalRule.IncidentType == nil {
						...
						childAlerts.SignalRule.IncidentType = &tfTypes.NullableSuccinctEntity{}
					...
					if childAlertsItem.SignalRule.Target == nil {
						...
						childAlerts.SignalRule.Target = &tfTypes.NullableSignalsAPITargetEntity{}
		...
		if resp.Events != nil {
			...
			for eventsCount, eventsItem := range resp.Events {
				...
				if eventsItem.Data == nil {
					...
					events.Data = &tfTypes.AlertsSirenEventEntityData{}
				}
		...
		if resp.Incidents != nil {
			r.Incidents = []tfTypes.PublicAPIV1IncidentsSuccinctEntity{}
			...
			for incidentsCount, incidentsItem := range resp.Incidents {
				var incidents tfTypes.PublicAPIV1IncidentsSuccinctEntity
		...
		if resp.Labels == nil {
			...
			r.Labels = &tfTypes.AlertsAlertEntityLabels{}
		}
		if resp.ParentAlerts != nil {
			r.ParentAlerts = []tfTypes.AlertsSirenAlertEntity{}
			...
			for parentAlertsCount, parentAlertsItem := range resp.ParentAlerts {
				var parentAlerts tfTypes.AlertsSirenAlertEntity
				...
				if parentAlertsItem.Labels == nil {
					...
					parentAlerts.Labels = &tfTypes.AlertsSirenAlertEntityLabels{}
				}
				...
				if parentAlertsItem.SignalRule == nil {
					...
					parentAlerts.SignalRule = &tfTypes.NullableSignalsAPIRuleEntity{}
					...
					if parentAlertsItem.SignalRule.CreatedBy == nil {
						...
						parentAlerts.SignalRule.CreatedBy = &tfTypes.NullableAuthorEntity{}
					...
					if parentAlertsItem.SignalRule.IncidentType == nil {
						...
						parentAlerts.SignalRule.IncidentType = &tfTypes.NullableSuccinctEntity{}
					...
					if parentAlertsItem.SignalRule.Target == nil {
						...
						parentAlerts.SignalRule.Target = &tfTypes.NullableSignalsAPITargetEntity{}
		...
		if resp.SignalRule == nil {
			...
			r.SignalRule = &tfTypes.NullableSignalsAPIRuleEntity{}
			...
			if resp.SignalRule.CreatedBy == nil {
				...
				r.SignalRule.CreatedBy = &tfTypes.NullableAuthorEntity{}
			...
			if resp.SignalRule.IncidentType == nil {
				...
				r.SignalRule.IncidentType = &tfTypes.NullableSuccinctEntity{}
			...
			if resp.SignalRule.Target == nil {
				...
				r.SignalRule.Target = &tfTypes.NullableSignalsAPITargetEntity{}
		...
		if resp.SignalTarget == nil {
			...
			r.SignalTarget = &tfTypes.NullableSignalsAPITargetEntity{}
