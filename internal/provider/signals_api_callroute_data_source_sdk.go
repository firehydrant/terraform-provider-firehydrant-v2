...
func (r *SignalsAPICallRouteDataSourceModel) RefreshFromSharedSignalsAPICallRoute(ctx context.Context, resp *shared.SignalsAPICallRoute) diag.Diagnostics {
...
func (r *SignalsAPICallRouteDataSourceModel) ToOperationsGetCallRouteRequest(ctx context.Context) (*operations.GetCallRouteRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
