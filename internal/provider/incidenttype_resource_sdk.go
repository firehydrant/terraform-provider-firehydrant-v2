...
func (r *IncidentTypeResourceModel) RefreshFromSharedIncidentType(ctx context.Context, resp *shared.IncidentType) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Template != nil {
			...
			if resp.Template.Impacts != nil {
				r.Template.Impacts = []tfTypes.CreateIncidentTypeImpact{}
				...
				for impactsCount, impactsItem := range resp.Template.Impacts {
					var impacts tfTypes.CreateIncidentTypeImpact
		...
		if resp.TemplateValues == nil {
			...
			r.TemplateValues = &tfTypes.NullableIncidentTypeTemplateValues{}
			if resp.TemplateValues.Environments != nil {
				r.TemplateValues.Environments = []tfTypes.IncidentTypeTemplateImpact{}
				...
				for environmentsCount, environmentsItem := range resp.TemplateValues.Environments {
					var environments tfTypes.IncidentTypeTemplateImpact
			...
			if resp.TemplateValues.Functionalities != nil {
				r.TemplateValues.Functionalities = []tfTypes.IncidentTypeTemplateImpact{}
				...
				for functionalitiesCount, functionalitiesItem := range resp.TemplateValues.Functionalities {
					var functionalities tfTypes.IncidentTypeTemplateImpact
			...
			if resp.TemplateValues.Services != nil {
				r.TemplateValues.Services = []tfTypes.IncidentTypeTemplateImpact{}
				...
				for servicesCount, servicesItem := range resp.TemplateValues.Services {
					var services tfTypes.IncidentTypeTemplateImpact
			...
			if resp.TemplateValues.Teams != nil {
				r.TemplateValues.Teams = []tfTypes.Team{}
				...
				for teamsCount, teamsItem := range resp.TemplateValues.Teams {
					...
					if teamsItem.DefaultSignalsEscalationPolicy == nil {
						...
						teams.DefaultSignalsEscalationPolicy = &tfTypes.NullableSuccinct{}
					...
					if teamsItem.Functionalities != nil {
						teams.Functionalities = []tfTypes.FunctionalityLite{}
						for functionalitiesCount1, functionalitiesItem1 := range teamsItem.Functionalities {
							var functionalities1 tfTypes.FunctionalityLite
							...
							if functionalitiesItem1.Labels == nil {
								...
								functionalities1.Labels = &tfTypes.FunctionalityLiteLabels{}
							}
					...
					if teamsItem.Memberships != nil {
						teams.Memberships = []tfTypes.Membership{}
					...
					if teamsItem.MsTeamsChannel == nil {
						...
						teams.MsTeamsChannel = &tfTypes.NullableIntegrationsMicrosoftTeamsV2Channel{}
						...
						if teamsItem.MsTeamsChannel.Incident == nil {
							...
							teams.MsTeamsChannel.Incident = &tfTypes.NullableIncident{}
							...
							if teamsItem.MsTeamsChannel.Incident.ConferenceBridges != nil {
								teams.MsTeamsChannel.Incident.ConferenceBridges = []tfTypes.IncidentsConferenceBridge{}
								for conferenceBridgesCount, conferenceBridgesItem := range teamsItem.MsTeamsChannel.Incident.ConferenceBridges {
									...
									if conferenceBridgesCount+1 > len(teams.MsTeamsChannel.Incident.ConferenceBridges) {
										...
										teams.MsTeamsChannel.Incident.ConferenceBridges[conferenceBridgesCount].PreviousHostAssignment = conferenceBridges.PreviousHostAssignment
							...
							if teamsItem.MsTeamsChannel.Incident.ContextObject == nil {
								...
								teams.MsTeamsChannel.Incident.ContextObject = &tfTypes.NullableIncidentsContextObject{}
							...
							if teamsItem.MsTeamsChannel.Incident.Conversations != nil {
								teams.MsTeamsChannel.Incident.Conversations = []tfTypes.ConversationsAPIReference{}
							...
							if teamsItem.MsTeamsChannel.Incident.CreatedBy == nil {
								...
								teams.MsTeamsChannel.Incident.CreatedBy = &tfTypes.NullableAuthor{}
							...
							if teamsItem.MsTeamsChannel.Incident.Environments != nil {
								teams.MsTeamsChannel.Incident.Environments = []tfTypes.Succinct{}
								for environmentsCount1, environmentsItem1 := range teamsItem.MsTeamsChannel.Incident.Environments {
									var environments1 tfTypes.Succinct
							...
							if teamsItem.MsTeamsChannel.Incident.FieldRequirements != nil {
								teams.MsTeamsChannel.Incident.FieldRequirements = []tfTypes.IncidentFieldRequirement{}
							...
							if teamsItem.MsTeamsChannel.Incident.Impacts != nil {
								teams.MsTeamsChannel.Incident.Impacts = []tfTypes.IncidentsImpact{}
								for impactsCount1, impactsItem1 := range teamsItem.MsTeamsChannel.Incident.Impacts {
									var impacts1 tfTypes.IncidentsImpact
									if impactsItem1.Condition == nil {
										impacts1.Condition = nil
									} else {
										impacts1.Condition = &tfTypes.NullableSeverityMatrixCondition{}
									...
									if impactsItem1.Conversations != nil {
										impacts1.Conversations = []tfTypes.ConversationsAPIReference{}
									...
									if impactsItem1.Impact == nil {
										...
										impacts1.Impact = &tfTypes.NullableSuccinct{}
							...
							if teamsItem.MsTeamsChannel.Incident.IncidentChannels != nil {
								teams.MsTeamsChannel.Incident.IncidentChannels = []tfTypes.IncidentsChannel{}
							...
							if teamsItem.MsTeamsChannel.Incident.IncidentTickets != nil {
								teams.MsTeamsChannel.Incident.IncidentTickets = []tfTypes.TicketingTicket{}
							...
							if teamsItem.MsTeamsChannel.Incident.IncidentType == nil {
								...
								teams.MsTeamsChannel.Incident.IncidentType = &tfTypes.NullableSuccinct{}
							...
							if teamsItem.MsTeamsChannel.Incident.Labels == nil {
								...
								teams.MsTeamsChannel.Incident.Labels = &tfTypes.NullableIncidentLabels{}
							}
							if teamsItem.MsTeamsChannel.Incident.LastNote == nil {
								teams.MsTeamsChannel.Incident.LastNote = nil
							} else {
								teams.MsTeamsChannel.Incident.LastNote = &tfTypes.NullableEventNote{}
								...
								if teamsItem.MsTeamsChannel.Incident.LastNote.Conversations != nil {
									teams.MsTeamsChannel.Incident.LastNote.Conversations = []tfTypes.ConversationsAPIReference{}
								...
								if teamsItem.MsTeamsChannel.Incident.LastNote.StatusPages != nil {
									teams.MsTeamsChannel.Incident.LastNote.StatusPages = []tfTypes.IncidentsStatusPage{}
							...
							if teamsItem.MsTeamsChannel.Incident.LifecycleMeasurements != nil {
								teams.MsTeamsChannel.Incident.LifecycleMeasurements = []tfTypes.IncidentsLifecycleMeasurement{}
							...
							if teamsItem.MsTeamsChannel.Incident.LifecyclePhases != nil {
								teams.MsTeamsChannel.Incident.LifecyclePhases = []tfTypes.IncidentsLifecyclePhase{}
							...
							if teamsItem.MsTeamsChannel.Incident.Milestones != nil {
								teams.MsTeamsChannel.Incident.Milestones = []tfTypes.IncidentsMilestone{}
							...
							if teamsItem.MsTeamsChannel.Incident.Organization == nil {
								...
								teams.MsTeamsChannel.Incident.Organization = &tfTypes.NullableOrganization{}
							...
							if teamsItem.MsTeamsChannel.Incident.RoleAssignments != nil {
								teams.MsTeamsChannel.Incident.RoleAssignments = []tfTypes.IncidentsRoleAssignment{}
							...
							if teamsItem.MsTeamsChannel.Incident.Services != nil {
								teams.MsTeamsChannel.Incident.Services = []tfTypes.Succinct{}
								for servicesCount1, servicesItem1 := range teamsItem.MsTeamsChannel.Incident.Services {
									var services1 tfTypes.Succinct
							...
							if teamsItem.MsTeamsChannel.Incident.SeverityConditionObject == nil {
								...
								teams.MsTeamsChannel.Incident.SeverityConditionObject = &tfTypes.NullableSeverityMatrixCondition{}
							...
							if teamsItem.MsTeamsChannel.Incident.SeverityImpactObject == nil {
								...
								teams.MsTeamsChannel.Incident.SeverityImpactObject = &tfTypes.NullableSeverityMatrixImpact{}
							...
							if teamsItem.MsTeamsChannel.Incident.StatusPages != nil {
								teams.MsTeamsChannel.Incident.StatusPages = []tfTypes.IncidentsStatusPage{}
							...
							if teamsItem.MsTeamsChannel.Incident.TeamAssignments != nil {
								teams.MsTeamsChannel.Incident.TeamAssignments = []tfTypes.IncidentsTeamAssignmentLite{}
							...
							if teamsItem.MsTeamsChannel.Incident.Ticket == nil {
								...
								teams.MsTeamsChannel.Incident.Ticket = &tfTypes.NullableTicketingTicket{}
								if teamsItem.MsTeamsChannel.Incident.Ticket.Assignees != nil {
									teams.MsTeamsChannel.Incident.Ticket.Assignees = []tfTypes.Author{}
								...
								if teamsItem.MsTeamsChannel.Incident.Ticket.CreatedBy == nil {
									...
									teams.MsTeamsChannel.Incident.Ticket.CreatedBy = &tfTypes.NullableAuthor{}
								...
								if teamsItem.MsTeamsChannel.Incident.Ticket.Link == nil {
									...
									teams.MsTeamsChannel.Incident.Ticket.Link = &tfTypes.NullableAttachmentsLink{}
								...
								if teamsItem.MsTeamsChannel.Incident.Ticket.Priority == nil {
									...
									teams.MsTeamsChannel.Incident.Ticket.Priority = &tfTypes.NullableTicketingPriority{}
					...
					if teamsItem.OwnedChecklistTemplates != nil {
						teams.OwnedChecklistTemplates = []tfTypes.ChecklistTemplate{}
					...
					if teamsItem.OwnedFunctionalities != nil {
						teams.OwnedFunctionalities = []tfTypes.FunctionalityLite{}
					...
					if teamsItem.OwnedRunbooks != nil {
						teams.OwnedRunbooks = []tfTypes.SlimRunbook{}
					...
					if teamsItem.OwnedServices != nil {
						teams.OwnedServices = []tfTypes.ServiceLite{}
					...
					if teamsItem.RespondingServices != nil {
						teams.RespondingServices = []tfTypes.ServiceLite{}
					...
					if teamsItem.Services != nil {
						teams.Services = []tfTypes.ServiceLite{}
						for servicesCount2, servicesItem2 := range teamsItem.Services {
							var services2 tfTypes.ServiceLite
							...
							if servicesItem2.Labels == nil {
								...
								services2.Labels = &tfTypes.ServiceLiteLabels{}
							}
					...
					if teamsItem.SlackChannel == nil {
						...
						teams.SlackChannel = &tfTypes.NullableIntegrationsSlackSlackChannel{}
...
func (r *IncidentTypeResourceModel) ToOperationsDeleteIncidentTypeRequest(ctx context.Context) (*operations.DeleteIncidentTypeRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var id string
	id = r.ID.ValueString()

	out := operations.DeleteIncidentTypeRequest{
		ID: id,
	}
...
func (r *IncidentTypeResourceModel) ToOperationsGetIncidentTypeRequest(ctx context.Context) (*operations.GetIncidentTypeRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *IncidentTypeResourceModel) ToOperationsUpdateIncidentTypeRequest(ctx context.Context) (*operations.UpdateIncidentTypeRequest, diag.Diagnostics) {
	var diags diag.Diagnostics

	var id string
	id = r.ID.ValueString()

	updateIncidentType, updateIncidentTypeDiags := r.ToSharedUpdateIncidentType(ctx)
	diags.Append(updateIncidentTypeDiags...)

	if diags.HasError() {
		return nil, diags
	}

	out := operations.UpdateIncidentTypeRequest{
		ID:                 id,
...
func (r *IncidentTypeResourceModel) ToSharedCreateIncidentType(ctx context.Context) (*shared.CreateIncidentType, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if !r.Template.Description.IsUnknown() && !r.Template.Description.IsNull() {
		*description1 = r.Template.Description.ValueString()
	} else {
		description1 = nil
	}
	var impacts []shared.CreateIncidentTypeImpact
	if r.Template.Impacts != nil {
		impacts = make([]shared.CreateIncidentTypeImpact, 0, len(r.Template.Impacts))
		for _, impactsItem := range r.Template.Impacts {
			...
			impacts = append(impacts, shared.CreateIncidentTypeImpact{
	...
	if r.Template.RunbookIds != nil {
		runbookIds = make([]string, 0, len(r.Template.RunbookIds))
	...
	var tagList []string
	if r.Template.TagList != nil {
		tagList = make([]string, 0, len(r.Template.TagList))
		for _, tagListItem := range r.Template.TagList {
			tagList = append(tagList, tagListItem.ValueString())
		}
	}
	var teamIds []string
	if r.Template.TeamIds != nil {
		teamIds = make([]string, 0, len(r.Template.TeamIds))
		for _, teamIdsItem := range r.Template.TeamIds {
			teamIds = append(teamIds, teamIdsItem.ValueString())
		}
	}
	template := shared.CreateIncidentTypeTemplate{
...
func (r *IncidentTypeResourceModel) ToSharedUpdateIncidentType(ctx context.Context) (*shared.UpdateIncidentType, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	var impacts []shared.UpdateIncidentTypeImpact
	if r.Template.Impacts != nil {
		impacts = make([]shared.UpdateIncidentTypeImpact, 0, len(r.Template.Impacts))
		for _, impactsItem := range r.Template.Impacts {
			var conditionID string
			conditionID = impactsItem.ConditionID.ValueString()
			...
			impacts = append(impacts, shared.UpdateIncidentTypeImpact{
				ConditionID: conditionID,
				ID:          id,
			})
		}
	...
	template := shared.UpdateIncidentTypeTemplate{
		CustomerImpactSummary: customerImpactSummary,
		Description:           description1,
		Impacts:               impacts,
		Labels:                labels,
