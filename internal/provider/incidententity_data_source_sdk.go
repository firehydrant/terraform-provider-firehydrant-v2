...
func (r *IncidentEntityDataSourceModel) ToOperationsGetIncidentRequest(ctx context.Context) (*operations.GetIncidentRequest, diag.Diagnostics) {
...
func (r *IncidentEntityDataSourceModel) RefreshFromSharedIncidentEntity(ctx context.Context, resp *shared.IncidentEntity) diag.Diagnostics {
	var diags diag.Diagnostics
	...
	if resp != nil {
		...
		if resp.Labels == nil {
			...
			r.Labels = &tfTypes.IncidentEntityLabels{}
		}
