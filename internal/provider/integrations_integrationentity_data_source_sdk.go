...
func (r *IntegrationsIntegrationEntityDataSourceModel) ToOperationsGetIntegrationRequest(ctx context.Context) (*operations.GetIntegrationRequest, diag.Diagnostics) {
...
func (r *IntegrationsIntegrationEntityDataSourceModel) RefreshFromSharedIntegrationsIntegrationEntity(ctx context.Context, resp *shared.IntegrationsIntegrationEntity) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		if resp.Connections != nil {
			r.Connections = []tfTypes.IntegrationsConnectionEntity{}
			...
			for connectionsCount, connectionsItem := range resp.Connections {
				var connections tfTypes.IntegrationsConnectionEntity
				...
				if connectionsItem.DefaultAuthorizedActor == nil {
					...
					connections.DefaultAuthorizedActor = &tfTypes.NullableAuthorEntity{}
				...
				if connectionsItem.Details == nil {
					...
					connections.Details = &tfTypes.IntegrationsConnectionEntityDetails{}
				}
		...
		if resp.Logo == nil {
			...
			r.Logo = &tfTypes.NullableIntegrationsIntegrationEntityLogoEntity{}
