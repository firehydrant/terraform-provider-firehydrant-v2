...
func (r *RunbooksExecutionDataSourceModel) RefreshFromSharedRunbooksExecution(ctx context.Context, resp *shared.RunbooksExecution) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.ExecutedFor == nil {
			...
			r.ExecutedFor = &tfTypes.NullableRunbooksExecutionExecutedFor{}
		...
		if resp.Runbook == nil {
			...
			r.Runbook = &tfTypes.NullableSlimRunbook{}
			if resp.Runbook.AttachmentRule == nil {
				...
				if resp.Runbook.AttachmentRule.UserData == nil {
					...
					r.Runbook.AttachmentRule.UserData = &tfTypes.NullableFHTypesGeneric{}
			...
			if resp.Runbook.Owner == nil {
				...
				r.Runbook.Owner = &tfTypes.NullableTeamLite{}
				...
				if resp.Runbook.Owner.CreatedBy == nil {
					...
					r.Runbook.Owner.CreatedBy = &tfTypes.NullableAuthor{}
		...
		if resp.Steps == nil {
			...
			r.Steps = &tfTypes.NullableRunbooksExecutionStep{}
			...
			if resp.Steps.ConferenceBridge == nil {
				...
				r.Steps.ConferenceBridge = &tfTypes.NullableIncidentsConferenceBridge{}
			...
			if resp.Steps.Config == nil {
				...
				r.Steps.Config = &tfTypes.NullableRunbooksExecutionStepConfig{}
			}
			r.Steps.Executable = types.BoolPointerValue(resp.Steps.Executable)
			if resp.Steps.Execution == nil {
				r.Steps.Execution = nil
			} else {
				r.Steps.Execution = &tfTypes.NullableRunbooksExecutionStepExecution{}
				if resp.Steps.Execution.Data == nil {
					r.Steps.Execution.Data = nil
				} else {
					r.Steps.Execution.Data = &tfTypes.NullableRunbooksExecutionStepExecutionData{}
				}
				...
				if resp.Steps.Execution.PerformedBy == nil {
					...
					r.Steps.Execution.PerformedBy = &tfTypes.NullableActor{}
				...
				if resp.Steps.Execution.WebhookDelivery == nil {
					...
					r.Steps.Execution.WebhookDelivery = &tfTypes.NullableRunbooksWebhookDelivery{}
			...
			if resp.Steps.Rule == nil {
				...
				if resp.Steps.Rule.UserData == nil {
					...
					r.Steps.Rule.UserData = &tfTypes.NullableFHTypesGeneric{}
