...
func (r *SignalsAPICallRouteResourceModel) RefreshFromSharedSignalsAPICallRoute(ctx context.Context, resp *shared.SignalsAPICallRoute) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Steps == nil {
			...
			r.Steps = &tfTypes.NullableSignalsAPICallRouteStep{}
			...
			if resp.Steps.Target == nil {
				...
				r.Steps.Target = &tfTypes.NullableSignalsAPITarget{}
...
func (r *SignalsAPICallRouteResourceModel) ToOperationsCreateTeamCallRouteRequest(ctx context.Context) (*operations.CreateTeamCallRouteRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPICallRouteResourceModel) ToOperationsDeleteCallRouteRequest(ctx context.Context) (*operations.DeleteCallRouteRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPICallRouteResourceModel) ToOperationsGetCallRouteRequest(ctx context.Context) (*operations.GetCallRouteRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPICallRouteResourceModel) ToOperationsUpdateCallRouteRequest(ctx context.Context) (*operations.UpdateCallRouteRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPICallRouteResourceModel) ToSharedCreateTeamCallRoute(ctx context.Context) (*shared.CreateTeamCallRoute, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPICallRouteResourceModel) ToSharedUpdateCallRoute(ctx context.Context) (*shared.UpdateCallRoute, diag.Diagnostics) {
	var diags diag.Diagnostics
