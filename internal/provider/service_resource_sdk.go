...
func (r *ServiceResourceModel) RefreshFromSharedService(ctx context.Context, resp *shared.Service) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Checklists != nil {
			r.Checklists = []tfTypes.ChecklistTemplate{}
		...
		if resp.Functionalities != nil {
			r.Functionalities = []tfTypes.Functionality{}
		...
		if resp.LastImport == nil {
			...
			r.LastImport = &tfTypes.NullableImportsImportableResource{}
			if resp.LastImport.ImportErrors != nil {
				r.LastImport.ImportErrors = []tfTypes.ImportsImportError{}
		...
		if resp.ManagedBySettings == nil {
			...
			r.ManagedBySettings = &tfTypes.ServiceManagedBySettings{}
		}
...
func (r *ServiceResourceModel) ToOperationsUpdateServiceRequest(ctx context.Context) (*operations.UpdateServiceRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ServiceResourceModel) ToSharedCreateService(ctx context.Context) (*shared.CreateService, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *ServiceResourceModel) ToSharedUpdateService(ctx context.Context) (*shared.UpdateService, diag.Diagnostics) {
	var diags diag.Diagnostics
	...
	if r.FunctionalitiesInput != nil {
		...
		for _, functionalitiesInputItem := range r.FunctionalitiesInput {
			...
			// Service#update.functionalities_input.removeService#update.functionalities_input.remove impedance mismatch: boolean != stringtrace=["Service#create.req.functionalities_input.[].summary"]
			var remove *bool
			summary := new(string)
			if !functionalitiesInputItem.Summary.IsUnknown() && !functionalitiesInputItem.Summary.IsNull() {
				*summary = functionalitiesInputItem.Summary.ValueString()
