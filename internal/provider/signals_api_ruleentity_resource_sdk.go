...
func (r *SignalsAPIRuleEntityResourceModel) ToSharedCreateTeamSignalRule(ctx context.Context) (*shared.CreateTeamSignalRule, diag.Diagnostics) {
...
func (r *SignalsAPIRuleEntityResourceModel) ToOperationsCreateTeamSignalRuleRequest(ctx context.Context) (*operations.CreateTeamSignalRuleRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIRuleEntityResourceModel) ToSharedUpdateTeamSignalRule(ctx context.Context) (*shared.UpdateTeamSignalRule, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIRuleEntityResourceModel) ToOperationsUpdateTeamSignalRuleRequest(ctx context.Context) (*operations.UpdateTeamSignalRuleRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIRuleEntityResourceModel) ToOperationsGetTeamSignalRuleRequest(ctx context.Context) (*operations.GetTeamSignalRuleRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SignalsAPIRuleEntityResourceModel) RefreshFromSharedSignalsAPIRuleEntity(ctx context.Context, resp *shared.SignalsAPIRuleEntity) diag.Diagnostics {
	var diags diag.Diagnostics
