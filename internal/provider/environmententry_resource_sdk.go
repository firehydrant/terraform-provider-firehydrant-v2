...
func (r *EnvironmentEntryResourceModel) RefreshFromSharedEnvironmentEntry(ctx context.Context, resp *shared.EnvironmentEntry) diag.Diagnostics {
...
func (r *EnvironmentEntryResourceModel) ToOperationsDeleteEnvironmentRequest(ctx context.Context) (*operations.DeleteEnvironmentRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *EnvironmentEntryResourceModel) ToOperationsGetEnvironmentRequest(ctx context.Context) (*operations.GetEnvironmentRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *EnvironmentEntryResourceModel) ToOperationsUpdateEnvironmentRequest(ctx context.Context) (*operations.UpdateEnvironmentRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *EnvironmentEntryResourceModel) ToSharedCreateEnvironment(ctx context.Context) (*shared.CreateEnvironment, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *EnvironmentEntryResourceModel) ToSharedUpdateEnvironment(ctx context.Context) (*shared.UpdateEnvironment, diag.Diagnostics) {
	var diags diag.Diagnostics
