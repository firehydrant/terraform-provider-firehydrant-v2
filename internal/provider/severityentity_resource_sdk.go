...
func (r *SeverityEntityResourceModel) ToSharedCreateSeverity(ctx context.Context) (*shared.CreateSeverity, diag.Diagnostics) {
...
func (r *SeverityEntityResourceModel) ToSharedUpdateSeverity(ctx context.Context) (*shared.UpdateSeverity, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SeverityEntityResourceModel) ToOperationsUpdateSeverityRequest(ctx context.Context) (*operations.UpdateSeverityRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SeverityEntityResourceModel) ToOperationsGetSeverityRequest(ctx context.Context) (*operations.GetSeverityRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SeverityEntityResourceModel) ToOperationsDeleteSeverityRequest(ctx context.Context) (*operations.DeleteSeverityRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
...
func (r *SeverityEntityResourceModel) RefreshFromSharedSeverityEntity(ctx context.Context, resp *shared.SeverityEntity) diag.Diagnostics {
	var diags diag.Diagnostics
