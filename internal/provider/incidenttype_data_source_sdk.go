...
func (r *IncidentTypeDataSourceModel) RefreshFromSharedIncidentType(ctx context.Context, resp *shared.IncidentType) diag.Diagnostics {
	...
	if resp != nil {
		...
		if resp.Template == nil {
			...
			r.Template = &tfTypes.NullableIncidentTypeTemplate{}
			...
			if resp.Template.Impacts != nil {
				r.Template.Impacts = []tfTypes.IncidentTypeTemplateImpact{}
				...
				for impactsCount, impactsItem := range resp.Template.Impacts {
					var impacts tfTypes.IncidentTypeTemplateImpact
...
func (r *IncidentTypeDataSourceModel) ToOperationsGetIncidentTypeRequest(ctx context.Context) (*operations.GetIncidentTypeRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
