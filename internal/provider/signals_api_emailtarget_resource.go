...
var _ resource.Resource = &SignalsAPIEmailTargetResource{}
var _ resource.ResourceWithImportState = &SignalsAPIEmailTargetResource{}

func NewSignalsAPIEmailTargetResource() resource.Resource {
	return &SignalsAPIEmailTargetResource{}
}

// SignalsAPIEmailTargetResource defines the resource implementation.
type SignalsAPIEmailTargetResource struct {
	// Provider configured SDK client.
	client *sdk.Firehydrant
}

// SignalsAPIEmailTargetResourceModel describes the resource data model.
type SignalsAPIEmailTargetResourceModel struct {
...
func (r *SignalsAPIEmailTargetResource) Metadata(ctx context.Context, req resource.MetadataRequest, resp *resource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_signals_api_email_target"
}

func (r *SignalsAPIEmailTargetResource) Schema(ctx context.Context, req resource.SchemaRequest, resp *resource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "SignalsAPIEmailTarget Resource",
...
func (r *SignalsAPIEmailTargetResource) Configure(ctx context.Context, req resource.ConfigureRequest, resp *resource.ConfigureResponse) {
...
func (r *SignalsAPIEmailTargetResource) Create(ctx context.Context, req resource.CreateRequest, resp *resource.CreateResponse) {
	var data *SignalsAPIEmailTargetResourceModel
	...
	if !(res.SignalsAPIEmailTarget != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedSignalsAPIEmailTarget(ctx, res.SignalsAPIEmailTarget)...)
	...
	if !(res1.SignalsAPIEmailTarget != nil) {
		resp.Diagnostics.AddError("unexpected response from API. Got an unexpected response body", debugResponse(res1.RawResponse))
		return
	}
	resp.Diagnostics.Append(data.RefreshFromSharedSignalsAPIEmailTarget(ctx, res1.SignalsAPIEmailTarget)...)
...
func (r *SignalsAPIEmailTargetResource) Read(ctx context.Context, req resource.ReadRequest, resp *resource.ReadResponse) {
	var data *SignalsAPIEmailTargetResourceModel
...
func (r *SignalsAPIEmailTargetResource) Update(ctx context.Context, req resource.UpdateRequest, resp *resource.UpdateResponse) {
	var data *SignalsAPIEmailTargetResourceModel
	var plan types.Object
...
func (r *SignalsAPIEmailTargetResource) Delete(ctx context.Context, req resource.DeleteRequest, resp *resource.DeleteResponse) {
	var data *SignalsAPIEmailTargetResourceModel
	var item types.Object
...
func (r *SignalsAPIEmailTargetResource) ImportState(ctx context.Context, req resource.ImportStateRequest, resp *resource.ImportStateResponse) {
