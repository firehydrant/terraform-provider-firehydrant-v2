...
func (r *IntegrationsStatuspageConnectionDataSourceModel) RefreshFromSharedIntegrationsStatuspageConnection(ctx context.Context, resp *shared.IntegrationsStatuspageConnection) diag.Diagnostics {
	var diags diag.Diagnostics

	if resp != nil {
		if resp.Conditions != nil {
			r.Conditions = []tfTypes.IntegrationsStatuspageCondition{}
			...
			for conditionsCount, conditionsItem := range resp.Conditions {
				var conditions tfTypes.IntegrationsStatuspageCondition
		...
		if resp.MilestoneMappings != nil {
			r.MilestoneMappings = []tfTypes.IntegrationsStatuspageMilestoneMapping{}
			...
			for milestoneMappingsCount, milestoneMappingsItem := range resp.MilestoneMappings {
				var milestoneMappings tfTypes.IntegrationsStatuspageMilestoneMapping
		...
		if resp.Severities != nil {
			r.Severities = []tfTypes.IntegrationsStatuspageSeverity{}
			...
			for severitiesCount, severitiesItem := range resp.Severities {
				var severities tfTypes.IntegrationsStatuspageSeverity
...
func (r *IntegrationsStatuspageConnectionDataSourceModel) ToOperationsGetStatuspageConnectionRequest(ctx context.Context) (*operations.GetStatuspageConnectionRequest, diag.Diagnostics) {
	var diags diag.Diagnostics
