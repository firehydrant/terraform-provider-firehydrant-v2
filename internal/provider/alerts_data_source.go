...
// AlertsDataSourceModel describes the data model.
type AlertsDataSourceModel struct {
	AlertID         types.String                           `tfsdk:"alert_id"`
	ChildAlerts     []tfTypes.AlertsSirenAlert             `tfsdk:"child_alerts"`
	...
	Events          []tfTypes.AlertsSirenEvent             `tfsdk:"events"`
	ID              types.String                           `tfsdk:"id"`
	Incidents       []tfTypes.PublicAPIV1IncidentsSuccinct `tfsdk:"incidents"`
	IntegrationName types.String                           `tfsdk:"integration_name"`
	IsExpired       types.Bool                             `tfsdk:"is_expired"`
	IsNoise         types.Bool                             `tfsdk:"is_noise"`
	Labels          *tfTypes.AlertsLabels                  `tfsdk:"labels"`
	ParentAlerts    []tfTypes.AlertsSirenAlert             `tfsdk:"parent_alerts"`
	...
	SignalRule      *tfTypes.NullableSignalsAPIRule        `tfsdk:"signal_rule"`
	SignalTarget    *tfTypes.NullableSignalsAPITarget      `tfsdk:"signal_target"`
...
func (r *AlertsDataSource) Metadata(ctx context.Context, req datasource.MetadataRequest, resp *datasource.MetadataResponse) {
	resp.TypeName = req.ProviderTypeName + "_alerts"
}

// Schema defines the schema for the data source.
func (r *AlertsDataSource) Schema(ctx context.Context, req datasource.SchemaRequest, resp *datasource.SchemaResponse) {
	resp.Schema = schema.Schema{
		MarkdownDescription: "Alerts DataSource",
				...
				NestedObject: schema.NestedAttributeObject{
					Attributes: map[string]schema.Attribute{
						...
						"signal_rule": schema.SingleNestedAttribute{
							...
							Description: `Signals_API_Rule model`,
						},
...
func (r *AlertsDataSource) Configure(ctx context.Context, req datasource.ConfigureRequest, resp *datasource.ConfigureResponse) {
...
func (r *AlertsDataSource) Read(ctx context.Context, req datasource.ReadRequest, resp *datasource.ReadResponse) {
	...
	resp.Diagnostics.Append(data.RefreshFromSharedAlerts(ctx, res.Alerts)...)
