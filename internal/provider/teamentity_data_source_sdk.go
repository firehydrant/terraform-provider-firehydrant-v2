...
func (r *TeamEntityDataSourceModel) ToOperationsGetTeamRequest(ctx context.Context) (*operations.GetTeamRequest, diag.Diagnostics) {
...
func (r *TeamEntityDataSourceModel) RefreshFromSharedTeamEntity(ctx context.Context, resp *shared.TeamEntity) diag.Diagnostics {
	var diags diag.Diagnostics
