...
func (s *Communication) ListTemplates(ctx context.Context, request operations.ListStatusUpdateTemplatesRequest, opts ...operations.Option) (*operations.ListStatusUpdateTemplatesResponse, error) {
...
func (s *Communication) GetTemplate(ctx context.Context, request operations.GetStatusUpdateTemplateRequest, opts ...operations.Option) (*operations.GetStatusUpdateTemplateResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Communication) UpdateTemplate(ctx context.Context, request operations.UpdateStatusUpdateTemplateRequest, opts ...operations.Option) (*operations.UpdateStatusUpdateTemplateResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
