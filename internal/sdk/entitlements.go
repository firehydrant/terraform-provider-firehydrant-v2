...
func (s *Entitlements) Retrieve(ctx context.Context, request operations.GetV1EntitlementsRequest, opts ...operations.Option) (*operations.GetV1EntitlementsResponse, error) {
