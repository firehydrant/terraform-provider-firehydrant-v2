...
func (s *Users) List(ctx context.Context, request operations.GetV1UsersRequest, opts ...operations.Option) (*operations.GetV1UsersResponse, error) {
...
// GetV1UsersID - Retrieve a single user
// Retrieve a single user by ID
func (s *Users) GetV1UsersID(ctx context.Context, request operations.GetV1UsersIDRequest, opts ...operations.Option) (*operations.GetV1UsersIDResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.GetV1UsersIDResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
...
func (s *Users) GetServices(ctx context.Context, request operations.GetV1UsersIDServicesRequest, opts ...operations.Option) (*operations.GetV1UsersIDServicesResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
