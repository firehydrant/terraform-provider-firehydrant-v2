...
func (s *ChecklistTemplates) Get(ctx context.Context, request operations.GetChecklistTemplateRequest, opts ...operations.Option) (*operations.GetChecklistTemplateResponse, error) {
