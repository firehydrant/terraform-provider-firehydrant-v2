...
func (s *OnCallSchedules) Delete(ctx context.Context, request operations.DeleteTeamOnCallScheduleRequest, opts ...operations.Option) (*operations.DeleteTeamOnCallScheduleResponse, error) {
