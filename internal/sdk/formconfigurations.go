...
func (s *FormConfigurations) Get(ctx context.Context, request operations.GetV1FormConfigurationsSlugRequest, opts ...operations.Option) (*operations.GetV1FormConfigurationsSlugResponse, error) {
