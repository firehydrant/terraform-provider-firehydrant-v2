...
func (s *AwsConnections) Get(ctx context.Context, request operations.GetAwsConnectionRequest, opts ...operations.Option) (*operations.GetAwsConnectionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
