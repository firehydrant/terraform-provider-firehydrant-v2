...
// ChangeTypes - Operations about change_types
...
func (s *ChangeTypes) List(ctx context.Context, request operations.GetV1ChangeTypesRequest, opts ...operations.Option) (*operations.GetV1ChangeTypesResponse, error) {
