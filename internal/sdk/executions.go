...
func (s *Executions) Delete(ctx context.Context, request operations.DeleteRunbookExecutionRequest, opts ...operations.Option) (*operations.DeleteRunbookExecutionResponse, error) {
