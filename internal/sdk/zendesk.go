...
func (s *Zendesk) SearchTickets(ctx context.Context, request operations.SearchZendeskTicketsRequest, opts ...operations.Option) (*operations.SearchZendeskTicketsResponse, error) {
