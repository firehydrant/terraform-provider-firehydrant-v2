...
type FirehydrantTerraformSDKTicketing struct {
	sdkConfiguration sdkConfiguration
}

func newFirehydrantTerraformSDKTicketing(sdkConfig sdkConfiguration) *FirehydrantTerraformSDKTicketing {
	return &FirehydrantTerraformSDKTicketing{
...
func (s *FirehydrantTerraformSDKTicketing) GetProject(ctx context.Context, request operations.GetTicketingProjectRequest, opts ...operations.Option) (*operations.GetTicketingProjectResponse, error) {
...
func (s *FirehydrantTerraformSDKTicketing) ListTags(ctx context.Context, request operations.ListTicketTagsRequest, opts ...operations.Option) (*operations.ListTicketTagsResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
