...
func (s *ProjectConfigurations) Create(ctx context.Context, request operations.CreateTicketingProjectConfigurationRequest, opts ...operations.Option) (*operations.CreateTicketingProjectConfigurationResponse, error) {
...
func (s *ProjectConfigurations) Get(ctx context.Context, request operations.GetTicketingProjectConfigRequest, opts ...operations.Option) (*operations.GetTicketingProjectConfigResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
