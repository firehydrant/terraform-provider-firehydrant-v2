...
func (s *Aws) GetCloudTrailBatch(ctx context.Context, request operations.GetAwsCloudTrailBatchRequest, opts ...operations.Option) (*operations.GetAwsCloudTrailBatchResponse, error) {
...
func (s *Aws) UpdateConnection(ctx context.Context, request operations.UpdateAwsConnectionRequest, opts ...operations.Option) (*operations.UpdateAwsConnectionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
