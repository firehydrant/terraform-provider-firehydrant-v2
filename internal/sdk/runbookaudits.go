...
func (s *RunbookAudits) List(ctx context.Context, request operations.GetV1RunbookAuditsRequest, opts ...operations.Option) (*operations.GetV1RunbookAuditsResponse, error) {
