...
func (s *Tickets) Create(ctx context.Context, request shared.PostV1TicketingTickets, opts ...operations.Option) (*operations.CreateTicketResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
// Delete a ticket
func (s *Tickets) Delete(ctx context.Context, request operations.DeleteTicketRequest, opts ...operations.Option) (*operations.DeleteTicketResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Tickets) Update(ctx context.Context, request operations.UpdateTicketRequest, opts ...operations.Option) (*operations.UpdateTicketResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
