...
func (s *AwsCloudtrailBatchEvents) List(ctx context.Context, request operations.GetAwsCloudtrailBatchEventsRequest, opts ...operations.Option) (*operations.GetAwsCloudtrailBatchEventsResponse, error) {
