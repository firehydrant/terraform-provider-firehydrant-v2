...
func (s *IncidentTags) List(ctx context.Context, request operations.GetV1IncidentTagsRequest, opts ...operations.Option) (*operations.GetV1IncidentTagsResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
