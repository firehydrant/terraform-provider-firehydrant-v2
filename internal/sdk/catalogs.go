...
func (s *Catalogs) Ingest(ctx context.Context, request operations.IngestCatalogDataRequest, opts ...operations.Option) (*operations.IngestCatalogDataResponse, error) {
...
func (s *Catalogs) Refresh(ctx context.Context, request operations.RefreshCatalogRequest, opts ...operations.Option) (*operations.RefreshCatalogResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
