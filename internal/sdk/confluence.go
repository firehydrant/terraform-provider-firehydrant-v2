...
func (s *Confluence) ListSpaces(ctx context.Context, request operations.ListConfluenceSpacesRequest, opts ...operations.Option) (*operations.ListConfluenceSpacesResponse, error) {
