...
// Generated from OpenAPI doc version 0.0.1 and generator version 2.681.1
...
func New(opts ...SDKOption) *Firehydrant {
	sdk := &Firehydrant{
		SDKVersion: "0.6.0",
		sdkConfiguration: config.SDKConfiguration{
			UserAgent:  "speakeasy-sdk/terraform 0.6.0 2.681.1 0.0.1 github.com/firehydrant/terraform-provider-firehydrant/internal/sdk",
