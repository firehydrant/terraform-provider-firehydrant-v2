...
func (s *StatusUpdateTemplates) Create(ctx context.Context, request shared.PostV1StatusUpdateTemplates, opts ...operations.Option) (*operations.CreateStatusUpdateTemplateResponse, error) {
