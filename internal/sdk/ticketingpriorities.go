...
func (s *TicketingPriorities) Get(ctx context.Context, request operations.GetTicketingPriorityRequest, opts ...operations.Option) (*operations.GetTicketingPriorityResponse, error) {
