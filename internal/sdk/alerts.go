...
func (s *Alerts) UpdateSignalsAlert(ctx context.Context, request operations.UpdateSignalsAlertRequest, opts ...operations.Option) (*operations.UpdateSignalsAlertResponse, error) {
	o := operations.Options{}
	supportedOptions := []string{
		operations.SupportedOptionTimeout,
	}
	...
	res := &operations.UpdateSignalsAlertResponse{
		StatusCode:  httpRes.StatusCode,
		ContentType: httpRes.Header.Get("Content-Type"),
		RawResponse: httpRes,
	}
