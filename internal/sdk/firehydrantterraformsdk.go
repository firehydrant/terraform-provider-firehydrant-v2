...
type SDKOption func(*FirehydrantTerraformSDK)

// WithServerURL allows the overriding of the default server URL
func WithServerURL(serverURL string) SDKOption {
	return func(sdk *FirehydrantTerraformSDK) {
...
func New(opts ...SDKOption) *FirehydrantTerraformSDK {
	sdk := &FirehydrantTerraformSDK{
		sdkConfiguration: sdkConfiguration{
			Language:          "go",
			OpenAPIDocVersion: "0.0.1",
			SDKVersion:        "0.0.7",
			GenVersion:        "2.488.4",
			UserAgent:         "speakeasy-sdk/terraform 0.0.7 2.488.4 0.0.1 github.com/speakeasy/terraform-provider-firehydrant-terraform-sdk/internal/sdk",
			Hooks:             hooks.New(),
		},
	}
