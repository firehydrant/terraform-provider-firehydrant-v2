...
// CreateSignalsEmailTargetTargetInput - The target that the email target will notify. This object must contain a `type`
...
type CreateSignalsEmailTargetTargetInput struct {
...
func (o *CreateSignalsEmailTargetTargetInput) GetID() string {
	if o == nil {
		return ""
	}
	return o.ID
...
func (o *CreateSignalsEmailTargetTargetInput) GetType() string {
	if o == nil {
		return ""
	}
	return o.Type
...
type CreateSignalsEmailTarget struct {
	...
	// "team", "user", or "slack_channel".
	//
	TargetInput *CreateSignalsEmailTargetTargetInput `json:"target,omitempty"`
}
...
func (o *CreateSignalsEmailTarget) GetRuleMatchingStrategy() *string {
	if o == nil {
		return nil
	}
...
func (o *CreateSignalsEmailTarget) GetTargetInput() *CreateSignalsEmailTargetTargetInput {
	if o == nil {
		return nil
	}
