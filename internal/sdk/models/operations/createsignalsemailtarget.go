...
type CreateSignalsEmailTargetResponse struct {
...
func (o *CreateSignalsEmailTargetResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *CreateSignalsEmailTargetResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
