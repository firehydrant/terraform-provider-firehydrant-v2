...
type UpdateIncidentImpactPutRequest struct {
	...
	UpdateIncidentImpactPut shared.UpdateIncidentImpactPut `request:"mediaType=application/json"`
}
...
func (o *UpdateIncidentImpactPutRequest) GetUpdateIncidentImpactPut() shared.UpdateIncidentImpactPut {
	if o == nil {
		return shared.UpdateIncidentImpactPut{}
	}
	return o.UpdateIncidentImpactPut
}

type UpdateIncidentImpactPutResponse struct {
...
func (o *UpdateIncidentImpactPutResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *UpdateIncidentImpactPutResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
