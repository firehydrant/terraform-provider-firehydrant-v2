...
type ListSignalsTransposersResponse struct {
...
func (o *ListSignalsTransposersResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *ListSignalsTransposersResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
