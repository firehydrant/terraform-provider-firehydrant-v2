...
type DeleteNuncConnectionResponse struct {
...
func (o *DeleteNuncConnectionResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *DeleteNuncConnectionResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
