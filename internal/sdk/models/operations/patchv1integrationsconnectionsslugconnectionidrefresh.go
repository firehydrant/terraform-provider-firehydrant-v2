...
func (o *PatchV1IntegrationsConnectionsSlugConnectionIDRefreshResponse) GetContentType() string {
	if o == nil {
		return ""
	}
...
func (o *PatchV1IntegrationsConnectionsSlugConnectionIDRefreshResponse) GetStatusCode() int {
	if o == nil {
		return 0
	}
	return o.StatusCode
...
func (o *PatchV1IntegrationsConnectionsSlugConnectionIDRefreshResponse) GetRawResponse() *http.Response {
	if o == nil {
		return nil
	}
