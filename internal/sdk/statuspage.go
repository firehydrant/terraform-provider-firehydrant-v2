...
func (s *Statuspage) UpdateConnection(ctx context.Context, request operations.UpdateStatuspageConnectionRequest, opts ...operations.Option) (*operations.UpdateStatuspageConnectionResponse, error) {
