...
type FirehydrantTerraformSDKSlack struct {
	sdkConfiguration sdkConfiguration
}

func newFirehydrantTerraformSDKSlack(sdkConfig sdkConfiguration) *FirehydrantTerraformSDKSlack {
	return &FirehydrantTerraformSDKSlack{
...
func (s *FirehydrantTerraformSDKSlack) GetEmojiAction(ctx context.Context, request operations.GetSlackEmojiActionRequest, opts ...operations.Option) (*operations.GetSlackEmojiActionResponse, error) {
...
func (s *FirehydrantTerraformSDKSlack) DeleteEmojiAction(ctx context.Context, request operations.DeleteSlackEmojiActionRequest, opts ...operations.Option) (*operations.DeleteSlackEmojiActionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *FirehydrantTerraformSDKSlack) ListWorkspaces(ctx context.Context, request operations.GetSlackWorkspacesRequest, opts ...operations.Option) (*operations.GetSlackWorkspacesResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
