...
func (s *Slack) CreateEmojiAction(ctx context.Context, request operations.CreateSlackEmojiActionRequest, opts ...operations.Option) (*operations.CreateSlackEmojiActionResponse, error) {
...
func (s *Slack) UpdateEmojiAction(ctx context.Context, request operations.UpdateSlackEmojiActionRequest, opts ...operations.Option) (*operations.UpdateSlackEmojiActionResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
