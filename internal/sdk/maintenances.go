...
func (s *Maintenances) List(ctx context.Context, request operations.ListScheduledMaintenancesRequest, opts ...operations.Option) (*operations.ListScheduledMaintenancesResponse, error) {
...
func (s *Maintenances) Create(ctx context.Context, request shared.PostV1ScheduledMaintenances, opts ...operations.Option) (*operations.CreateScheduledMaintenanceResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
...
func (s *Maintenances) Delete(ctx context.Context, request operations.DeleteScheduledMaintenanceRequest, opts ...operations.Option) (*operations.DeleteScheduledMaintenanceResponse, error) {
	hookCtx := hooks.HookContext{
		Context:        ctx,
